...
class RouterListenerTest extends TestCase
{
    ...
    {
        return array(
            array(80, 443, 'https://aplikasi.gui-group.co.id/', 80, 443),
    ...
    {
        $kernel = $this->getMockBuilder('Symfony\Component\HttpKernel\HttpKernelInterface')->getMock();
        $request = Request::create('https://aplikasi.gui-group.co.id/');
    ...
    {
        $kernel = $this->getMockBuilder('Symfony\Component\HttpKernel\HttpKernelInterface')->getMock();
        $request = Request::create('https://aplikasi.gui-group.co.id/', 'post');
        $event = new GetResponseEvent($kernel, $request, HttpKernelInterface::MASTER_REQUEST);
        ...
        $kernel = $this->getMockBuilder('Symfony\Component\HttpKernel\HttpKernelInterface')->getMock();
        $request = Request::create('https://aplikasi.gui-group.co.id/', 'get');
    ...
    {
        return array(
            array(array('_route' => 'foo'), 'Matched route "{route}".', array('route' => 'foo', 'route_parameters' => array('_route' => 'foo'), 'request_uri' => 'https://aplikasi.gui-group.co.id/', 'method' => 'GET')),
            array(array(), 'Matched route "{route}".', array('route' => 'n/a', 'route_parameters' => array(), 'request_uri' => 'https://aplikasi.gui-group.co.id/', 'method' => 'GET')),
        );
    }
