...
class PhpGeneratorDumperTest extends TestCase
{
    ...
    public function testDumpWithRoutes()
    {
        ...
        $this->assertEquals('https://aplikasi.gui-group.co.id/app.php/testing/bar', $absoluteUrlWithParameter);
        $this->assertEquals('https://aplikasi.gui-group.co.id/app.php/testing2', $absoluteUrlWithoutParameter);
