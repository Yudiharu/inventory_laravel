...
class UrlGeneratorTest extends TestCase
{
    public function testAbsoluteUrlWithPort80()
    {
        ...
        $this->assertEquals('https://aplikasi.gui-group.co.id/app.php/testing', $url);
    }
    ...
    public function testAbsoluteUrlWithExtraParameters()
    {
        ...
        $this->assertEquals('https://aplikasi.gui-group.co.id/app.php/testing?foo=bar', $url);
    }
    ...
    public function testSchemeRequirementForcesAbsoluteUrl()
    {
        ...
        $routes = $this->getRoutes('test', new Route('/', array(), array(), array(), '', array('http')));
        $this->assertEquals('https://aplikasi.gui-group.co.id/app.php/', $this->getGenerator($routes, array('scheme' => 'https'))->generate('test'));
    }
