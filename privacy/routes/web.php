...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    Route::post('memo/edit_pembelian', 'MemoController@edit_pembelian')->name('memo.edit_pembelian');
    Route::post('memo/hapus_pembelian', 'MemoController@hapus_pembelian')->name('memo.hapus_pembelian');
    Route::post('memo/void_pembelian', 'MemoController@void_pembelian')->name('memo.void_pembelian');
