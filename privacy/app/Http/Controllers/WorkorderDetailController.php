...
class WorkorderDetailController extends Controller
{
   ...
   public function updateAjax(Request $request)
    ...
    public function destroy($pembeliandetail)
    {
        ...
        $cek_pemakaian = Pemakaian::on($konek)->where('no_wo',$wo_detail->no_wo)->first();
        ...
        //JOIN 3 TABEL
        $cek_tarik = WorkorderDetail::on($konek)->join('pemakaian_detail','workorder_detail.kode_produk','=','pemakaian_detail.kode_produk')->join('pemakaian','pemakaian.no_pemakaian','=','pemakaian_detail.no_pemakaian')->where('pemakaian.no_wo',$wo_detail->no_wo)->where('pemakaian_detail.kode_produk',$wo_detail->kode_produk)->first();
