                ...
                if($cek_company == '04' || $cek_company == '0401' || $cek_company == '03' || $cek_company == '05' || $cek_company == '06' || $cek_company == '02'){
                    ...
                    for ($i = 0; $i < $leng; $i++) { 
                        ...
                        if($cek_produk->kode_kategori == 'APD'){
                            $gt_apd += abs($data[$i]['qty'] * $data[$i]['harga']);
                            $gt_apd_detail += $data[$i]['qty'] * $data[$i]['harga'];
                        }

                        if($cek_produk->kode_kategori == 'BAN'){
                            $gt_ban += abs($data[$i]['qty'] * $data[$i]['harga']);
                            $gt_ban_detail += $data[$i]['qty'] * $data[$i]['harga'];
                        }

                        if($cek_produk->kode_kategori == 'BBM'){
                            $gt_bbm += abs($data[$i]['qty'] * $data[$i]['harga']);
                            $gt_bbm_detail += $data[$i]['qty'] * $data[$i]['harga'];
                        }

                        if($cek_produk->kode_kategori == 'OLI'){
                            $gt_oli += abs($data[$i]['qty'] * $data[$i]['harga']);
                            $gt_oli_detail += $data[$i]['qty'] * $data[$i]['harga'];
                        }

                        if($cek_produk->kode_kategori == 'SPRT'){
                            $gt_sprt += abs($data[$i]['qty'] * $data[$i]['harga']);
                            $gt_sprt_detail += $data[$i]['qty'] * $data[$i]['harga'];
                        }

                        if($cek_produk->kode_kategori == 'UNIT'){
                            $gt_unit += abs($data[$i]['qty'] * $data[$i]['harga']);
                            $gt_unit_detail += $data[$i]['qty'] * $data[$i]['harga'];
                        }
                        
                        if($cek_produk->kode_kategori == 'SLDG'){
                            $gt_sldg += abs($data[$i]['qty'] * $data[$i]['harga']);
                            $gt_sldg_detail += $data[$i]['qty'] * $data[$i]['harga'];
                        }
                    }
