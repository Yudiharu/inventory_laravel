...
class PembelianController extends Controller
{
    ...
    public function index()
    {
        ...
        if($level != 'ap'){
            return view('admin.pembelian.index3',compact('Costcenter','create_url','Vendor','Company','no_pembelian','period', 'nama_lokasi','nama_company','Lokasi'));
        }else{
    ...
    public function exportPDF(){
        ...
        $tes_save = $company_user->kode_company.". ".$company_user->nama_company."/".$setupfolder->folder."/".$setupfolder->subfolder."/".$tahun."/".$bulan."/".$request.".pdf";
