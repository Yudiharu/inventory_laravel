...
<?php $__env->startSection('title', 'Endofmonth Parts'); ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                      <br>
                                        <?php echo e(Form::label('parrt', 'Pilih Part:')); ?>

                                        <?php echo e(Form::select('part', $part,null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Parto','required'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        $('#button1').click( function () {
            ...
            $.ajax({
                url: '<?php echo route('endofmonthpart.change'); ?>',
                type: 'POST',
                data:formData,
