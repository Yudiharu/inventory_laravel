    ...
    <div class="left">
        <table width="50%" style="  font-size: 10pt" border="0">
            ...
            <tr>
                <td >Alamat</td>
                <td>:</td>
                <td><?php echo e(substr($pembelian->vendor->alamat,0,26)); ?></td>
            </tr>
            <tr>
                <td>Kontak</td>
                <td>:</td>
...
<div class="content">
    <section class="list-item">
        <table class="grid" style="font-size: 10pt; width: 19cm; padding-top:-58px" border="0" >
            <thead>
            <tr >
                <th width="5%"></th>
                <th width="35%" ></th>
...
<?php } 
        ...
        <table class="grid" style="font-size: 10pt; width: 19cm; padding-top: -36px; padding-left: -9px;" border="0" >
            <tr >
                <td  colspan="7" rowspan="7" style="font-size: 10pt; vertical-align: top; width: 58%">
                    <strong>Terbilang : <br>
                        <?php echo Terbilang::make($grand_total, ' rupiah'); ?>
