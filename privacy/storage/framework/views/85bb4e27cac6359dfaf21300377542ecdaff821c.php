...
<?php $__env->startSection('title', 'Calculate Pemakaian'); ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Calculate <b>Pemakaian</b></h4>
                </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        $('#button1').click( function () {
            ...
            $.ajax({
              url: '<?php echo route('checkpemakaian.change'); ?>',
              type: 'POST',
              data:{
                  'index': index,
                  'periode': periode,
