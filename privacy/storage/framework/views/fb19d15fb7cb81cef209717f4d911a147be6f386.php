...
<?php $__env->startSection('title', 'Vendor COA'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Vendor <b><?php echo e($vendor->nama_vendor); ?></b></font>
    </span>
    ...
    <div class="box box-danger">
        <div class="box-body"> 
            ...
            <center><kbd>ADD FORM</kbd></center><br>
                ...
                <?php echo e(Form::hidden('kode_vendor',$vendor->id, ['class'=> 'form-control','readonly','id'=>'KodeCust1'])); ?>

                <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','readonly','id'=>'Id1'])); ?>

                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('Nomors', 'Vendor:')); ?>

                            <?php echo e(Form::text('noomor', $vendor->nama_vendor, ['class'=> 'form-control','id'=>'Nama1','readonly'])); ?>

                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <?php echo e(Form::label('npwps', 'Kode Coa:')); ?>

                            <?php echo e(Form::select('kode_coa', $coa->sort(),null, ['class'=> 'form-control select2','id'=>'KodeCoa1','name'=>'KodeCoa1','style'=>'width: 100%','placeholder' => ''])); ?>
    ...
    function formatStatus(n) {
        ...
        $(document).ready(function(){
            ...
            $('#editmt').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('vendor.edit_coa'); ?>',
                    type: 'POST',
                    data : {
                        'kode_coa': coa,
                        'id': id,
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('vendor.store_coa'); ?>',
                type:'POST',
                data:formData,
