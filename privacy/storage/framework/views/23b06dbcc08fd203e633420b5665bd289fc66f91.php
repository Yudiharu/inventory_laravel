...
<?php $__env->startSection('content'); ?>
    ...
    <span class="pull-right">
        ...
        <a href="https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/opnamedetail/exportpdf?no_opname=<?php echo e($opname->no_opname); ?>" target="_blank" id="getform"><button type="button" class="btn btn-warning btn-xs print-button" id="button6">GET FORM OPNAME <i class="fa fa-print"></i></button></a>
            ...
            <div class="addform">
                    ...
                    <center><kbd>EDIT FORM</kbd></center><br>
                        <div class="row">   
                                ...
                                <?php echo e(Form::hidden('kode_produk',null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'Produk', 'id'=>'Produk','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nama_produk',null,
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_mesin', null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'No Mesin','id'=>'Mesin','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('hpp', null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'HPP','id'=>'Harga','autocomplete'=>'off','readonly'])); ?>
