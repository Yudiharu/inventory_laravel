...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>LAPORAN DATA PEMAKAIAN BAN</title>
    <style>
        body {
...
<div class="header">
    <h1>LAPORAN DATA PEMAKAIAN BAN</h1>
...
?>
    <table class="table_content" style="margin-bottom: 25px;width: 100%;">
        ...
        <?php foreach ($pemakaianbandetail as $key => $row) : ?>
        <tbody>
        ...
        <tfoot>
        <tr class="border">
            <td class="border" colspan="13" style="font-weight: bold">Total</td>
...
<?php if (! empty($pemakaianbandetail)){ ?>
