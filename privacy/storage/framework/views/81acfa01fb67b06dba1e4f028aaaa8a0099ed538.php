                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('type', ['Vendor' => 'Vendor', 'Sopir' => 'Sopir'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'type1','required','onchange'=>"getcoa();"])); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('type', ['Vendor' => 'Vendor', 'Sopir' => 'Sopir'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'type','required'=>'required','onchange'=>"getcoa2();"])); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::textArea('alamat', null, ['class'=> 'form-control','rows'=>'4','id'=>'Alamat','readonly'])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('telp', null, ['class'=> 'form-control','id'=>'Telp','required'=>'required','onkeypress'=>"return hanyaAngka(event)",'readonly'])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="number1" style="display:none;">
                                <?php echo e(Form::text('hp', null, ['class'=> 'form-control','id'=>'Hp','required'=>'required', 'name'=>'hp','readonly'])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_kontak', null, ['class'=> 'form-control','id'=>'Kontak','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)",'readonly'])); ?>
    ...
    function hanyaAngka(e, decimal) {
        ...
        function formatType(n) {
            if(n == 'Vendor'){
                ...
                return n.replace(/Vendor/, stat);
            }else{
                var stat = "<span style='color:#1a80c9'><b>Sopir</b></span>";
                return n.replace(/Sopir/, stat);
            }
        }
