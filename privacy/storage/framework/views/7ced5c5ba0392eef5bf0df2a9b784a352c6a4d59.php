        ...
        <br><br>
            <?php
                ...
                <?php if ($asetalat != 'SEMUA') { ?>
                    <h1>LAPORAN PEMAKAIAN ALAT KATEGORI <?php echo $kategori; ?> NO ASET <?php echo $asetalat; ?></h1>
                <?php }else { ?>
                    <h1>LAPORAN PEMAKAIAN ALAT KATEGORI <?php echo $kategori; ?></h1>
                <?php } ?>
            <?php } 
                else{?>
                <?php if ($asetalat != 'SEMUA'){ ?>
                    <h1>LAPORAN PEMAKAIAN ALAT NO ASET <?php echo $asetalat; ?></h1>
                <?php } else { ?>
                    <h1>LAPORAN PEMAKAIAN ALAT</h1>
                <?php } ?>
            <?php } ?>
