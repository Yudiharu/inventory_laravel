...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-bank')) : ?>
                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addform">
                        <i class="fa fa-plus"></i> New Bank</button>
                    <?php endif; // app('laratrust')->can ?>

                    <span class="pull-right">  
                        <font style="font-size: 16px;"><b>BANK</b></font>
                    </span>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_bank',null, ['class'=> 'form-control','style'=>'width: 100%' ,'id'=>'nama1','required', 'placeholder'=>'Nama Bank','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_bank',null, ['class'=> 'form-control','style'=>'width: 100%' ,'id'=>'Nama2','required', 'placeholder'=>'Nama Bank','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-bank')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-bank')) : ?>
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var kode_bank = select.find('td:eq(0)').text();
                    $('.hapus-button').show();
                    $('.edit-button').show();
            ...
            $('#editbank').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('bank.edit_bank'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_bank
                    },
            ...
            $('#hapusbank').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('bank.hapus_bank'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_bank
                            },
