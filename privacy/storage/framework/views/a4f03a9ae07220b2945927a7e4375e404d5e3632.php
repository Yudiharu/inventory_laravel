                                ...
                                <div class="fade-in-fade-out">
                                    <div class="col-md-4">
                                        <div class="form-group-warning" style="border-style: inset; background-color: #949494;">
                                            <?php echo e(Form::label('warning', 'PRODUK INI SUDAH MELEWATI BATAS MAKSIMUM QTY', ['style'=>'color:red'])); ?>

                                            <?php echo e(Form::label('text', 'Max Qty = ', ['style'=>'color:red'])); ?>

                                            <?php echo e(Form::label('max_qty', null, ['style'=>'color:red','id'=>'Warning'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $("select[id='Produk']").change(function(){
            ...
            var token = $("input[name='_token']").val();
            $.ajax({
                url: "<?php echo route('pembeliandetail.selectAjax2'); ?>",
                method: 'POST',
                data: {
                        kode_produk:kode_produk, _token:token,
                        'no': no_pembelian
