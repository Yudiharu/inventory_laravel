    ...
    <div class="left">
        <table width="50%" style="  font-size: 10pt" border="0">
            ...
            <tr>
                <td >Alamat</td>
                <td>:</td>
                <td style="font-size: 9pt"><?php echo e($pembelian->vendor->alamat); ?></td>
            </tr>
            <tr>
                <td>Kontak</td>
                <td>:</td>
            ...
            <?php foreach ($pembeliandetail as $key => $value): ?>
                <tr >
                    ...
                    <?php if($pembelian->jenis_po == 'Stock'){ ?>
                        <td ><?php echo $value->produk->nama_produk?>
                        <?php if($value->produk->partnumber != "-") {?>
                            <br>Partnumber : <?php echo $value->produk->partnumber ?>
                        <?php }?>
                        </td>
...
$total_ppn = round(($subtotal - $total_diskon)*($pembelian->ppn / 100));
...
<?php } 
        ...
        <table class="grid" style="font-size: 10pt; width: 21.5cm; padding-top: 38px; padding-left: 12px" border="0" >
            <tr >
                <td  colspan="7" rowspan="6" style="font-size: 10pt; vertical-align: top; width: 59%">
                    <strong>Terbilang : <br>
                        <?php echo Terbilang::make($grand_total, ' rupiah'); ?>
        ...
        <table width="100%" style="font-size:10pt; text-align:center;padding:0px; margin:0px; border-collapse:collapse" border="0">
            ...
            <tr style="padding:0px; margin:0px">
                ...
                <?php if (file_exists($cekdisetujui)) { ?>
                    <td><img src="<?php echo e($cekdisetujui); ?>" alt="" height="70px" width="90px" align="center"></td>
                <?php }else { ?>
                    <td><br><br><br></td>
                <?php } ?>
                
                <?php if (file_exists($cekdiketahui)) { ?>
                    <td><img src="<?php echo e($cekdiketahui); ?>" alt="" height="70px" width="90px" align="center"></td>
                <?php }else { ?>
                    <td><br><br><br></td>
                <?php } ?>
            </tr>
        ...
        <table width="100%" style="font-size:10pt; text-align:center;padding:0px; margin:0px; border-collapse:collapse" border="0">
            ...
            <tr style="padding:0px; margin:0px">
                ...
                <?php if (file_exists($cekdiperiksa)) { ?>
                    <td><img src="<?php echo e($cekdiperiksa); ?>" alt="" height="70px" width="90px" align="center"></td>
                <?php }else { ?>
                    <td><br><br><br></td>
                <?php } ?>
