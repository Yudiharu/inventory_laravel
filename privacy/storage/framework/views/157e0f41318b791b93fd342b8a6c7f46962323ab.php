    ...
    <section class="list-item">
        <table class="grid" style="font-size: 10pt; width: 19cm;" border="0" >
            ...
            <?php endforeach ?>
                ...
                <td style="padding-left: 15px"><?php echo e($pembelian->deskripsi); ?></td>
                ...
                <td></td>
                <td></td>
                <td style="padding-left: 95px"align="right">Rp</td>
...
<table class="grid" style="font-size: 10pt; width: 19cm; padding-top: 20px; width: 96%" border="0" >
    <tr >
        <td  colspan="7" rowspan="7" style="font-size: 10pt; vertical-align: top; width: 55%">
            <strong>Terbilang : <br>
                <?php echo Terbilang::make($grand_total, ' rupiah'); ?>
            </strong>
        </td>
        <td width="23%" align="right">Subtotal </td>
...
<br>
<table class="grid" style="margin-top: 0px; padding-top: 0px; width: 19cm" border="0">
    <tr>
...
<div class="footer" style="font-size: 10pt;padding-top: 0.7cm">
    <div class="tgl">
