        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addpemakaian").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_sub_laravel/admin/pemakaian/"+no_pemakaian+"/detail");
                    var print = $("#printpemakaian").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_sub_laravel/admin/pemakaian/export2?no_pemakaian="+no_pemakaian);
                    var status = colom;
                    var item = colom2;
