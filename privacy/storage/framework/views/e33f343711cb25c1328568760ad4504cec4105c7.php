<?php $__env->startSection('title', 'Laporan Retur Pembelian'); ?>
        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <?php echo Form::open(['route' => ['laporanreturpembelian.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
    ...
    <script type="text/javascript">
        ...
        function cetakpdf() {
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    url:'<?php echo route('laporanreturpembelian.export'); ?>',
                    type:'GET',
                    data:formData,
