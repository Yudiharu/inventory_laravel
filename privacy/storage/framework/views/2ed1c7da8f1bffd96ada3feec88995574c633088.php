...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-jasaor')) : ?>
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textArea('keterangan', null, ['class'=> 'form-control','id'=>'Keterangan', 'autocomplete'=>'off','rows'=>'4', 'placeholder'=>'Deskripsi', 'onkeypress'=>"return pulsar(event,this)"])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-jasaor')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-jasaor')) : ?>
