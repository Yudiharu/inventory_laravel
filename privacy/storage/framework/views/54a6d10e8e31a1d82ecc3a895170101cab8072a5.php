<?php $__env->startSection('title', 'Memo Detail'); ?>

<?php $__env->startSection('content_header'); ?>
<h1> Detail Memo <?php echo e($memo->no_memo); ?></h1>
...
<body onLoad="load()">
    ...
    <div class="box">
        <div class="box-header with-border">
            <div class="">
                <a href="<?php echo e($list_url); ?>" class="btn btn-info btn-sm">List Memo</a>
            </div>
        ...
        <div class="box-body"> 
            <div class="row col-md-12 addform">
                    ...
                    <?php echo Form::open(['route' => ['memodetail.store',$memo->no_memo],'method' => 'post','id'=>'form']); ?>
                        ...
                        <div class="row">   
                            <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_memo',$memo->no_memo, ['class'=> 'form-control','readonly'])); ?>
            ...
            <div class="row col-md-12 editform">
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['route'=>'memodetail.updateajax','method' => 'post','id'=>'form2']); ?>
                    ...
                    <div class="row">   
                        <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_memo',$memo->no_memo, ['class'=> 'form-control','readonly','id'=>'Memo'])); ?>
            ...
            <table class="table table-bordered table-hover" id="data-table" width="100%">
                ...
                <tbody>
                    <?php $__currentLoopData = $memodetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($row->no_memo); ?></td>
            ...
            <span class="row"><?php echo e($memodetail->links()); ?></span>
        </div>
    </div>
</body>
<?php $__env->stopSection(); ?>
