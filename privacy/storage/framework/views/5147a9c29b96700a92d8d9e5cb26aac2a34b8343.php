<?php $__env->startSection('title', 'Retur Pembelian Detail'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Retur Pembelian <b><?php echo e($returpembelian->no_returpembelian); ?></b></font>
    </span>
                        ...
                        <div class="row">   
                                <div class="col-md-2">
                                    <div class="form-group1">
                                        ...
                                        <?php echo e(Form::text('no_returpembelian',$returpembelian->no_returpembelian, ['class'=> 'form-control','readonly','id'=>'noretur'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group2">
                                        ...
                                        <?php echo e(Form::text('no_penerimaan',$returpembelian->no_penerimaan, ['class'=> 'form-control','readonly','id'=>'noterima'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group3">
                                        ...
                                        <?php echo e(Form::select('kode_produk',$Produk->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','required'=>'required','id'=>'kode_produk','onchange'=>'getinfo();'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group8">
                                        <?php echo e(Form::label('qty_terima', 'QTY Penerimaan:')); ?>

                                        <?php echo e(Form::text('qty_terima', null, ['class'=> 'form-control','required'=>'required',
                                         'id'=>'Qty','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group11">
                                        ...
                                        <?php echo e(Form::text('landedcost',null, ['class'=> 'form-control','required','readonly',
                    ...
                    <div class="row">   
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_penerimaan',$returpembelian->no_penerimaan, ['class'=> 'form-control','readonly','id'=>'Penerimaan'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('landedcost',null, ['class'=> 'form-control','id'=>'Landed2','required','readonly','autocomplete'=>'off'])); ?>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        var no_returpembelian = $('#noretur').val();
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_inventory_laravel/admin/returpembeliandetail/getDatabyID?id='+no_returpembelian,
    ...
    <script>
        ...
        function getinfo(){
            ...
            $.ajax({
                url:'<?php echo route('returpembeliandetail.getinfo'); ?>',
                type:'POST',
                data : {
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'<?php echo route('returpembeliandetail.store'); ?>',
                    type:'POST',
                    data:formData,
