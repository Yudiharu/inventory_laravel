<?php $__env->startSection('title', 'Jasa / Non-Stock'); ?>
                ...
                <div class="box-body">
                   <!--   -->
                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addform">
                        <i class="fa fa-plus"></i> New Jasa / Non-Stock</button>
                </div>
            </div>
                        ...
                        <div class="row">
                            <!--  -->
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('jenis_item', ['Jasa' => 'Jasa', 'Non-Stock' => 'Non-Stock'], null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'Pilih','id'=>'Jenis1','required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('satuan_item', $Satuan, null, ['class'=> 'form-control','id'=>'Satuan1','required'=>'required', 'placeholder'=>'Satuan Item', 'autocomplete'=>'off', 'placeholder'=>'Pilih'])); ?>
                ...
                <div class="row">
                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('jenis_item', null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'Pilih','id'=>'Jenis','readonly'])); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('satuan_item', null, ['class'=> 'form-control','id'=>'Satuan','required'=>'required', 'placeholder'=>'Satuan Item', 'autocomplete'=>'off','readonly'])); ?>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textArea('keterangan', null, ['class'=> 'form-control','id'=>'Keterangan', 'autocomplete'=>'off','rows'=>'4'])); ?>
