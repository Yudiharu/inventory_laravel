                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_kategori', null, ['class'=> 'form-control','id'=>'Kode1', 'placeholder'=>'Kode Kategori','required'=>'required','autocomplete'=>'off','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 6 Karakter", 'maxlength'=>'6', 'style'=>"text-transform: uppercase;"] )); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_kategori', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Kategori', 'style'=>"text-transform: uppercase;",'autocomplete'=>'off'])); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_kategori', null, ['class'=> 'form-control','id'=>'Nama2','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
