                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('kode_pajak', null, ['class'=> 'form-control','id'=>'Kode2','required', 'onkeypress'=>"return pulsar(event,this)", 'autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_pajak', null, ['class'=> 'form-control','id'=>'Nama2','required', 'onkeypress'=>"return pulsar(event,this)", 'autocomplete'=>'off'])); ?>
