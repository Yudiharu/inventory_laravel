        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addtransfer").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_sub_laravel/admin/transfer/"+no_transfer+"/detail");
                    var print = $("#printtransfer").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_sub_laravel/admin/transfer/cetakPDF?no_transfer="+no_transfer);
                    var status = colom;
                    var item = colom2;
