        ...
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-transferin')) : ?>
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('transferin.getkode'); ?>',
                        type:'POST',
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var print2 = $("#printzoom3").attr("href","http://localhost/gui_inventory_laravel/admin/transferin/exportpdf2?no_journal="+no_journal + "&no_transferin="+no_transfer);
                    var status = colom;
                    var item = colom2;
           ...
           $('#button1').click( function () {
            ...
            $('#detailjurnal2').click( function () {
                ...
                var no_journal = select.find('td:eq(8)').text();
                $.ajax({
                    url: '<?php echo route('transferin.getDatajurnal2'); ?>',
                    type: 'GET',
                    data : {
                        'id': no_journal,
                    },
            ...
            function cekjurnal2(){
                ...
                $.ajax({
                    url:'<?php echo route('transferin.cekjurnal2'); ?>',
                    type:'POST',
                    data : {
