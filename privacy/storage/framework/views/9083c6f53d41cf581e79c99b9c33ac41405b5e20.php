                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('mengetahui', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Mengetahui', 'autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('jabatan', null, ['class'=> 'form-control','id'=>'Nama2', 'placeholder'=>'Jabatan', 'autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
