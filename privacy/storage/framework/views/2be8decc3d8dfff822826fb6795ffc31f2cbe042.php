                        ...
                        <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nama_produk', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Produk', 'style'=>"text-transform: uppercase;",'autocomplete'=>'off'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('partnumber', null, ['class'=> 'form-control','id'=>'Part1', 'placeholder'=>'Part Number','required'=>'required','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_produk', null, ['class'=> 'form-control','id'=>'Nama2','autofocus'=>'autofocus','required'=>'required','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('partnumber',null, ['class'=> 'form-control','id'=>'Part2','required'=>'required','autocomplete'=>'off','readonly', 'style'=>"text-transform: uppercase;"])); ?>
