...
<?php $__env->startSection('title', 'Retur Penjualan Detail'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Retur Penjualan <b><?php echo e($returpenjualan->no_retur_jual); ?></b></font>
    </span>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                    <div class="form-group1">
                                        <?php echo e(Form::label('No Penjualan', 'No Retur:')); ?>

                                        <?php echo e(Form::text('no_retur_jual',$returpenjualan->no_retur_jual, ['class'=> 'form-control','readonly','id'=>'noretur1'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group2">
                                        ...
                                        <?php echo e(Form::text('no_penjualan',$returpenjualan->no_penjualan, ['class'=> 'form-control','readonly','id'=>'nojual1'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group3">
                                        ...
                                        <?php echo e(Form::text('partnumber', null, ['class'=> 'form-control','id'=>'Parts','required'=>'required','style'=>'width: 100%','autocomplete'=>'off','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                        <div class="form-group6">
                                            <?php echo e(Form::label('qty_stock', 'Qty Penjualan:')); ?>

                                            <?php echo e(Form::text('qty', null, ['class'=> 'form-control','readonly','id'=>'Stock'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group7">
                                        ...
                                        <?php echo e(Form::text('qty_retur', null, ['class'=>'form-control','required'=>'required','id'=>'QTY','onkeyup'=>'check();','autocomplete'=>'off'])); ?>

                                    </div>
                                </div>

                                        <?php echo e(Form::hidden('harga',null, ['class'=> 'form-control','id'=>'Harga','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group8">
                                        ...
                                        <?php echo e(Form::number('harga_jual',null, ['class'=> 'form-control','id'=>'Jual','readonly'])); ?>
                    ...
                    <div class="row">   
                        <div class="col-md-2">
                                <div class="form-group">
                                    <?php echo e(Form::label('No Retur', 'No Retur:')); ?>

                                    <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','id'=>'ID'])); ?>

                                    <?php echo e(Form::text('no_retur_jual',$returpenjualan->no_retur_jual, ['class'=> 'form-control','readonly','id'=>'noretur2'])); ?>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_penjualan',$returpenjualan->returpenjualan, ['class'=> 'form-control','readonly','id'=>'nopakai2'])); ?>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_produk',null, ['class'=> 'form-control','id'=>'Produk2','required'=>'required','readonly'])); ?>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('qty_retur', null, ['class'=> 'form-control','id'=>'Qty2','required'=>'required','onkeyup'=>"check2()",'autocomplete'=>'off'])); ?>

                                </div>
                            </div>

                                    <?php echo e(Form::hidden('harga',null, ['class'=> 'form-control','id'=>'Harga2','required'=>'required','readonly'])); ?>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group8">
                                        ...
                                        <?php echo e(Form::number('harga_jual',null, ['class'=> 'form-control','id'=>'Jual2','readonly'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        var no_retur = $('#noretur1').val();
            ...
            processing: true,
            serverSide: true,
            ajax:'https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/returjualdetail/getDatabyID?id='+no_retur,
  ...
  <script>
        ...
        function stock(){
            ...
            $.ajax({
                url:'<?php echo route('returjualdetail.stockproduk'); ?>',
                type:'POST',
                data : {
        ...
        function getstock(){
            ...
            var partnumber= $('#Partserial').val();
             ...
             $.ajax({
                url:'<?php echo route('returjualdetail.getstock'); ?>',
                type:'POST',
                data : {
        ...
        function check(){
            ...
            var submit = document.getElementById("submit");
            $.ajax({
                url:'<?php echo route('returjualdetail.qtycheck'); ?>',
                type:'POST',
                data : {
                        'id': kode_produk,
                        'satuan': satuan,
        ...
        function check2(){
            ...
            var submit = document.getElementById("submit");
            $.ajax({
                url:'<?php echo route('returjualdetail.qtycheck2'); ?>',
                type:'POST',
                data : {
                        'id': kode_produk,
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'<?php echo route('returjualdetail.check'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            // Check if empty of not
                $.ajax({
                    url:'<?php echo route('returjualdetail.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
