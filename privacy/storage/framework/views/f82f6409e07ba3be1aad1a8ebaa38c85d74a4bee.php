        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var print2 = $("#printzoom3").attr("href","http://localhost/gui_inventory_laravel/admin/returpembelian/exportpdf2?no_journal="+no_journal + "&no_returpembelian="+no_returpembelian);
                    var status = colom;
                    var item = colom2;
            ...
            $('#detailjurnal2').click( function () {
                ...
                var no_journal = select.find('td:eq(8)').text();
                $.ajax({
                    url: '<?php echo route('returpembelian.getDatajurnal2'); ?>',
                    type: 'GET',
                    data : {
                        'id': no_journal,
                    },
            ...
            function cekjurnal2(){
                ...
                $.ajax({
                    url:'<?php echo route('returpembelian.cekjurnal2'); ?>',
                    type:'POST',
                    data : {
