                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('kode_transaksi', null, ['class'=> 'form-control','id'=>'Kode_e','required', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_transaksi', null, ['class'=> 'form-control','id'=>'Nama_e','required', 'onkeypress'=>"return pulsar(event,this)",'autocomplete'=>'off'])); ?>
