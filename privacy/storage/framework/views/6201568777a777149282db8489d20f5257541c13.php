...
?>
    <table class="table_content" style="margin-bottom: 25px;width: 100%;">
        ...
        <tr class="border" style="background-color: #e6f2ff">
            ...
            <th class="border" width="">No Penerimaan</th>
            ...
            <th class="border" width="">Landed Cost</th>
            <th class="border" width="">Subtotal</th>
        </tr>
        </thead>

        <?php foreach ($penerimaandetail as $key => $row) : ?>
        <tbody>
        ...
        ?>
            ...
            <tr class="border">
                ...
                <td class="border" align="left"><?php echo $row->no_penerimaan?></td>
                <td class="border" align="left"><?php echo $row->no_pembelian?></td>
                <td class="border" align="left"><?php echo $row->tanggal_penerimaan?></td>
                ...
                <td class="border" align="right"><?php echo number_format($row->landedcost,'0',',','.') ?></td>
                <td class="border" align="right">Rp. <?php echo number_format(($row->harga * $row->qty) + $row->landedcost,'0',',','.') ?></td>
            </tr>
            ...
            $subtotal += ($row->harga * $row->qty) + $row->landedcost;
        ...
        <tfoot>
        <tr class="border">
            <td class="border" colspan="7" style="font-weight: bold">Total</td>
