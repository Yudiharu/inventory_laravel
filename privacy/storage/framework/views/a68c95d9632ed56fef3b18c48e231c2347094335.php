                ...
                <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','readonly','id'=>'Id1'])); ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('kode_operator',$operator->sort(), "-",
                            ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Operator1'])); ?>
...
<script>
    ...
    $(function(){
        ...
        $('#data2-table').DataTable({
            processing: true,
            serverSide: true,
            ajax:link+'/gui_inventory_laravel/admin/alat/getDatabyID?kode_customer='+kode,
            data:{'kode':kode},
            columns: [
                { data: 'id', name: 'id', visible: false },
                { data: 'kode_lokasi', name: 'kode_lokasi' },
                { data: 'operator.nama_operator', name: 'kode_operator',  "defaultContent": "<i>-</i>" },
