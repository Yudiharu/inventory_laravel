...
<?php $__env->startSection('title', 'Laporan Transfer Out'); ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Laporan <b>Transfer Out</b></h4>
                </div>
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['route' => ['laporantransferout.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::hidden('status', 'CLOSED', ['class'=> 'form-control','id'=>'status1','readonly'])); ?>

                                    <!--<div class="col-sm-4">-->
                                    <!--    <div class="form-group">  -->
                                    <!--        <?php echo e(Form::label('pilih', 'Status:')); ?>              -->
                                    <!--        <?php echo e(Form::select('status', ['POSTED' => 'POSTED'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'status1','required'=>'required'])); ?>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <div class="col-sm-4">  
