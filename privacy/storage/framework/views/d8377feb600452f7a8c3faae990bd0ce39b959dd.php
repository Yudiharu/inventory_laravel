        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addtransferin").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_sub_laravel_trial/admin/transferin/"+no_transfer+"/detail");
                    var print = $("#printtransferin").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_sub_laravel_trial/admin/transferin/exportpdf?no_transferin="+no_transfer);
                    var status = colom;
                    var item = colom2;
