                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('qty_assembling', null, ['class'=>'form-control','required'=>'required','id'=>'QTY','autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::number('hpp',null, ['class'=> 'form-control','id'=>'Harga'])); ?>
              ...
              <div class="modal-content">
                ...
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php echo Form::open(['id'=>'EDIT']); ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','id'=>'id1'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::number('hpp',null, ['class'=> 'form-control','id'=>'Harga1'])); ?>
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var status = select.find('td:eq(7)').text();
                    var item = select.find('td:eq(6)').text();
                    var no_journal = select.find('td:eq(8)').text();
                    var data = $('#data-table').DataTable().row(select).data();
                    var id = data['id'];

                    var add = $("#addassembling").attr("href","http://localhost/gui_inventory_laravel/admin/assembling/"+id+"/detail");
                    var print2 = $("#printzoom3").attr("href","http://localhost/gui_inventory_laravel/admin/assembling/exportpdf3?no_journal="+no_journal + "&id="+id);
