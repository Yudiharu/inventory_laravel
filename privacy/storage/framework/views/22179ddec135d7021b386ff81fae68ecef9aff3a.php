...
<?php $__env->startSection('content'); ?>
    ...
    <span class="pull-right">
        ...
        <a href="http://localhost/gui_inventory_laravel/admin/opnamedetail/exportpdf?no_opname=<?php echo e($opname->no_opname); ?>" target="_blank" id="getform"><button type="button" class="btn btn-warning btn-xs print-button" id="button6">GET FORM OPNAME <i class="fa fa-print"></i></button></a>
