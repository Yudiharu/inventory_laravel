...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>LAPORAN DATA TRANSFER IN BARANG</title>
    <style>
        .header, h1 {
            font-size: 11pt;
            margin-bottom: 0px;
...
<div class="fixed-header">
        ...
        <br><br>
            <?php
                if ($kategori != 'SEMUA') {?>
                    <h1>LAPORAN TRANSFER IN BARANG KATEGORI <?php echo $kategori; ?></h1>
            <?php } 
                else{?>
                    <h1>LAPORAN TRANSFER IN BARANG</h1>
            <?php } ?>
...
?>
    <table class="grid1" style="margin-bottom: 25px;width: 100%; font-size: 11px">
        ...
        <tbody>
            <?php $__currentLoopData = $transferindetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <tr>
                <td><?php echo $key+1 ?></td>
                <td><?php echo $row->no_trf_in?></td>
