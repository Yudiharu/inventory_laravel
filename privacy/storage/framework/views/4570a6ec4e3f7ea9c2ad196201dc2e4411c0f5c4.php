                        ...
                        <?php } ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('Tanggal', 'Tanggal Adjustment:')); ?>

                                    <?php echo e(Form::date('tanggal', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal','required'])); ?>
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    $.ajax({
                        url: '<?php echo route('adjustment.historia'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_penyesuaian
                        },
           ...
           $('#button1').click( function () {
            ...
            $('#detailjurnal2').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('adjustment.getDatajurnal2'); ?>',
                    type: 'GET',
                    data : {
                        'id': no_journal,
                    },
            ...
            function cekjurnal2(){
                ...
                $.ajax({
                    url:'<?php echo route('adjustment.cekjurnal2'); ?>',
                    type:'POST',
                    data : {
