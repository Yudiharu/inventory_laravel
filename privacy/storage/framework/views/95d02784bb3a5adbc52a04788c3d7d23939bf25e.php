...
<div class="fixed-header">
    ...
    <table class="grid1" style="margin-bottom: 25px;width: 100%; font-size: 10px">
        ...
        <?php $__currentLoopData = $opnamedetail_cetak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php
                    if ($returbeli == 'true' || $semua == 'true') {?>
                        ...
                        <?php
                            if ($field1 == 'SEMUA' || $field1 == 'Amount') {?>
                                <?php if (app('laratrust')->can('read-hpp')) : ?>
                                <td><?php echo e(number_format($item->retur_beli_amount,'0','.',',')); ?></td>
                                <?php endif; // app('laratrust')->can ?>
                        <?php } ?>
                <?php } ?>
                <?php
                    if ($returjual == 'true' || $semua == 'true') {?>
                        ...
                        <?php
                            if ($field1 == 'SEMUA' || $field1 == 'Amount') {?>
                                <?php if (app('laratrust')->can('read-hpp')) : ?>
                                <td><?php echo e(number_format($item->retur_jual_amount,'0','.',',')); ?></td>
                                <?php endif; // app('laratrust')->can ?>
                        <?php } ?>
                <?php } ?>
                <?php
                    if ($returpakai == 'true' || $semua == 'true') {?>
                        ...
                        <?php
                            if ($field1 == 'SEMUA' || $field1 == 'Amount') {?>
                                <?php if (app('laratrust')->can('read-hpp')) : ?>
                                <td><?php echo e(number_format($item->retur_pakai_amount,'0','.',',')); ?></td>
                                <?php endif; // app('laratrust')->can ?>
                        <?php } ?>
                <?php } ?>
                <?php
            ...
            $subtotal12 += $item->retur_pakai_amount;
        ...
        <tr style="background-color: #dbdbdb">
            <?php
                ...
                <?php } 
                    ...
                    <?php
                        if ($returpakai == 'true' || $semua == 'true') {?>
                            <td align="center">&nbsp;<?php echo number_format($grandtotaljumlah12,'0',',','.');?></td>
                    <?php } ?> 
