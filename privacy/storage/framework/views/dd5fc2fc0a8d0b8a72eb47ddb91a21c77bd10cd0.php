        ...
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-returjual')) : ?>
...
<div class="modal fade" id="addform"  role="dialog">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?php echo e(Form::label('Nomor', 'Nomor Penjualan:',['class'=>'control-label'])); ?>

                                        <?php echo e(Form::select('no_penjualan', $Penjualan->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'nojual1','required','onchange'=>"getcustomer()"])); ?>

                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?php echo e(Form::label('Tanggal Retur', 'Tanggal Retur:')); ?>

                                        <?php echo e(Form::date('tgl_retur_jual', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1','required'=>'required'])); ?>

                                    </div>
                                </div>
                                <?php echo e(Form::hidden('kode_customer',null, ['class'=> 'form-control','id'=>'customer1','readonly'])); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group7">
                                        ...
                                        <?php echo e(Form::textArea('keterangan', null, ['class'=> 'form-control','rows'=>'4','id'=>'ket1', 'placeholder'=>'Keterangan', 'autocomplete'=>'off','required', 'onkeypress'=>"return pulsar(event,this)"])); ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">                                
                            <?php echo e(Form::hidden('no_retur_jual', null, ['class'=> 'form-control','id'=>'Retur2','readonly'])); ?>

                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('Type', 'No Retur Penjualan:')); ?>

                                    <?php echo e(Form::text('no_retur_jual', null, ['class'=> 'form-control','id'=>'nojual2','readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::date('tgl_retur_jual', null,['class'=> 'form-control','id'=>'Tanggal2'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('no_penjualan', $Penjualan->sort(), null, ['class'=> 'form-control select2','id'=>'penjualan','onchange'=>"getcustomer2()",'style'=>'width: 100%','placeholder' => ''])); ?>

                                </div>
                            </div>
                            <?php echo e(Form::hidden('kode_customer',null, ['class'=> 'form-control','id'=>'customer','readonly'])); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::textArea('keterangan', null, ['class'=> 'form-control','rows'=>'4','id'=>'ket2', 'autocomplete'=>'off','required', 'onkeypress'=>"return pulsar(event,this)"])); ?>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-returjual')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-returjual')) : ?>
            ...
            <?php if (app('laratrust')->can('add-returjual')) : ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('returjual.getkode'); ?>',
                        type:'POST',
        ...
        function getcustomer(){
            ...
            $.ajax({
                url:'<?php echo route('returjual.getcustomer'); ?>',
                type:'POST',
                data : {
                        'id': penjualan
                    },
        ...
        function getcustomer2(){
            ...
            $.ajax({
                url:'<?php echo route('returjual.getcustomer2'); ?>',
                type:'POST',
                data : {
                        'id': penjualan
                    },
        ...
        $(function() {
            $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo route('returjual.data'); ?>',
 ...
 //FUNGSI BREAKDOWN
        $(document).ready(function() {
                    ...
                    $('#data-table tbody').on( 'click', 'td.details-control', function () {
                        ...
                        $.ajax({
                            url: '<?php echo route('returjual.showdetail'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode
                            },
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addpemakaian").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/returjual/"+no_retur_jual+"/detail");
                    var print = $("#printreturjual").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/returjual/exportpdf?no_retur_jual="+no_retur_jual);
                    var status = colom;
            ...
            $('#button1').click( function () {
                ...
                swal({
                    ...
                    // alert( table.rows('.selected').data().length +' row(s) selected' );
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('returjual.posting'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_retur_jual,
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('returjual.unposting'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_retur_jual,
                                'no_penjualan': no_penjualan
            ...
            $('#editreturjual').click( function () {
                ...
                console.log(no_retur_jual);
                $.ajax({
                    url: '<?php echo route('returjual.edit_retur_jual'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_retur_jual
                    },
            ...
            $('#hapusreturjual').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('returjual.hapus_penjualan'); ?>',
                            type: 'POST',
                            data : {
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('returjual.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('returjual.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
