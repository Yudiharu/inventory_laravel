...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-kategorior')) : ?>
                ...
                <?php echo Form::open(['id'=>'ADD']); ?>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo e(Form::label('coabiaya', 'COA COGS:')); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo e(Form::label('CC', 'Cost Center Persediaan:')); ?>

                                    <?php echo e(Form::select('cost_center', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Costpersediaan1','onchange'=>"getcc2()"])); ?>

                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo e(Form::label('CC', 'Cost Center COGS:')); ?>

                                    <?php echo e(Form::select('cost_center', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Cost1','onchange'=>"getcc()"])); ?>
                            ...
                            <?php echo e(Form::hidden('coa_infra', null, ['class'=> 'form-control','id'=>'coainfra1','readonly'])); ?>
                            ...
                            <?php echo e(Form::hidden('coabiaya_infra', null, ['class'=> 'form-control','id'=>'coabiayainfra1','readonly'])); ?>
                            ...
                            <?php echo e(Form::hidden('cc_gut', null, ['class'=> 'form-control','id'=>'ccgut1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_gutjkt', null, ['class'=> 'form-control','id'=>'ccgutjkt1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_emkl', null, ['class'=> 'form-control','id'=>'ccemkl1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_pbm', null, ['class'=> 'form-control','id'=>'ccpbm1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_infra', null, ['class'=> 'form-control','id'=>'ccinfra1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_sub', null, ['class'=> 'form-control','id'=>'ccsub1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_depo', null, ['class'=> 'form-control','id'=>'ccdepo1','readonly'])); ?>

                            
                            <?php echo e(Form::hidden('cc_gut_persediaan', null, ['class'=> 'form-control','id'=>'ccgutpersediaan1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_gutjkt_persediaan', null, ['class'=> 'form-control','id'=>'ccgutjktpersediaan1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_emkl_persediaan', null, ['class'=> 'form-control','id'=>'ccemklpersediaan1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_pbm_persediaan', null, ['class'=> 'form-control','id'=>'ccpbmpersediaan1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_infra_persediaan', null, ['class'=> 'form-control','id'=>'ccinfrapersediaan1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_sub_persediaan', null, ['class'=> 'form-control','id'=>'ccsubpersediaan1','readonly'])); ?>

                            <?php echo e(Form::hidden('cc_depo_persediaan', null, ['class'=> 'form-control','id'=>'ccdepopersediaan1','readonly'])); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group38">
                                <?php echo e(Form::label('coa_infra', 'COA Persediaan:')); ?>

                                <?php echo e(Form::select('coa_infra', $Coa->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'coainfra2'])); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group32">
                                <?php echo e(Form::label('coabiaya_gut', 'COA COGS:')); ?>
                            ...
                            <div class="form-group33">
                                <?php echo e(Form::label('coabiaya_emkl', 'COA COGS:')); ?>
                            ...
                            <div class="form-group34">
                                <?php echo e(Form::label('coabiaya_pbm', 'COA COGS:')); ?>
                            ...
                            <div class="form-group35">
                                <?php echo e(Form::label('coabiaya_depo', 'COA COGS:')); ?>
                            ...
                            <div class="form-group36">
                                <?php echo e(Form::label('coabiaya_sub', 'COA COGS:')); ?>
                            ...
                            <div class="form-group37">
                                <?php echo e(Form::label('coabiaya_gutjkt', 'COA COGS:')); ?>
                            ...
                            <div class="form-group39">
                                <?php echo e(Form::label('coabiaya_infra', 'COA COGS:')); ?>

                                <?php echo e(Form::select('coabiaya_infra', $Coa->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'coabiayainfra2'])); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group47">
                                ...
                                <?php echo e(Form::select('cc_gut_persediaan', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costgutpersediaan2'])); ?>

                            </div>
                            <div class="form-group48">
                                <?php echo e(Form::label('CC', 'Cost Center Persediaan:')); ?>

                                <?php echo e(Form::select('cc_gutjkt_persediaan', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costgutjktpersediaan2'])); ?>

                            </div>
                            <div class="form-group49">
                                <?php echo e(Form::label('CC', 'Cost Center Persediaan:')); ?>

                                <?php echo e(Form::select('cc_emkl_persediaan', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costemklpersediaan2'])); ?>

                            </div>
                            <div class="form-group50">
                                <?php echo e(Form::label('CC', 'Cost Center Persediaan:')); ?>

                                <?php echo e(Form::select('cc_pbm_persediaan', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costpbmpersediaan2'])); ?>

                            </div>
                            <div class="form-group51">
                                <?php echo e(Form::label('CC', 'Cost Center Persediaan:')); ?>

                                <?php echo e(Form::select('cc_infra_persediaan', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costinfrapersediaan2'])); ?>

                            </div>
                            <div class="form-group52">
                                <?php echo e(Form::label('CC', 'Cost Center Persediaan:')); ?>

                                <?php echo e(Form::select('cc_sub_persediaan', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costsubpersediaan2'])); ?>

                            </div>
                            <div class="form-group53">
                                <?php echo e(Form::label('CC', 'Cost Center Persediaan:')); ?>

                                <?php echo e(Form::select('cc_depo_persediaan', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costdepopersediaan2'])); ?>
                        ...
                        <div class="col-md-6">
                            <div class="form-group40">
                                ...
                                <?php echo e(Form::select('cc_gut', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costgut2'])); ?>

                            </div>
                            <div class="form-group41">
                                <?php echo e(Form::label('CC', 'Cost Center COGS:')); ?>

                                <?php echo e(Form::select('cc_gutjkt', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costgutjkt2'])); ?>

                            </div>
                            <div class="form-group42">
                                <?php echo e(Form::label('CC', 'Cost Center COGS:')); ?>

                                <?php echo e(Form::select('cc_emkl', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costemkl2'])); ?>

                            </div>
                            <div class="form-group43">
                                <?php echo e(Form::label('CC', 'Cost Center COGS:')); ?>

                                <?php echo e(Form::select('cc_pbm', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costpbm2'])); ?>

                            </div>
                            <div class="form-group44">
                                <?php echo e(Form::label('CC', 'Cost Center COGS:')); ?>

                                <?php echo e(Form::select('cc_infra', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costinfra2'])); ?>

                            </div>
                            <div class="form-group45">
                                <?php echo e(Form::label('CC', 'Cost Center COGS:')); ?>

                                <?php echo e(Form::select('cc_sub', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costsub2'])); ?>

                            </div>
                            <div class="form-group46">
                                <?php echo e(Form::label('CC', 'Cost Center COGS:')); ?>

                                <?php echo e(Form::select('cc_depo', $Costcenter->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'costdepo2'])); ?>
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-kategorior')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-kategorior')) : ?>
