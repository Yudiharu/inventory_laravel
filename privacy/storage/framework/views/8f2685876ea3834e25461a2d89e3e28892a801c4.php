...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-kapalor')) : ?>
                    <button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addform">
                        <i class="fa fa-plus"></i> New kapal</button>
                    <?php endif; // app('laratrust')->can ?>

                    <span class="pull-right">  
                        <a href="https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/kapal/exportexcel?" target="_blank" id="printpembelian"><button type="button" class="btn bg-black btn-xs"><i class="fa fa-print"></i> CETAK LIST KAPAL</button></a>
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_kapal', null, ['class'=> 'form-control','id'=>'Nama','required', 'onkeypress'=>"return pulsar(event,this)", 'autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('type', ['MV'=>'MV','KM'=>'KM','Tug Boat'=>'Tug Boat','Tongkang'=>'Tongkang'],null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Tipe2'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::selectYear('tahun', 2000, 2040, null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Tahun','required'=>'required', 'autocomplete'=>''])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('no_asset_kapal', null, ['class'=> 'form-control','id'=>'Asset', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <?php if (app('laratrust')->can('update-kapalor')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-kapalor')) : ?>
        ...
        $(document).ready(function(){
            ...
            $('#kapal-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var addmt = $("#addlokasi").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/kapal/"+kode_kapal+"/detaillokasi");
                    $('.hapus-button').show();
                    $('.edit-button').show();
