        ...
        <div class="right">
            <table style="float: right; font-size: 10pt" border="0">
                <tr>
                    ...
                    <td style="width: 10px">:</td>
                    <td><?php echo date_format($opname->created_at,"d/m/Y") ?></td>
                </tr>
                <tr>
                    <td >Reference</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Status</td>
                    <td>:</td>
                    <td><?php echo e($opname->status); ?></td>
                </tr>
            </table>
        </div>
    </div>
        ...
        <table style="padding-left:0mm; font-size:10pt">
            ...
            <?php foreach ($ledger as $key => $value): ?>
                <tr >
                    ...
                    <td style="width: 130px; text-align: right"><?php echo number_format(abs($value->debit),'0','.',',') ?></td>
                    <td style="width: 130px; text-align: right"><?php echo number_format(abs($value->kredit),'0','.',',') ?></td>
                </tr>
            <?php endforeach ?>
        </table>
    </div>
    ...
    <div class="left">
        <table width="100%" style="  font-size: 10pt" border="0">
            <tr >
                ...
                <td style="width: 130px; text-align: right "><?php echo number_format(abs($grand_total),'0','.',',') ?></td>
                <td style="width: 130px; text-align: right "><?php echo number_format(abs($grand_total),'0','.',',') ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="left">
        <table style="padding-left:1mm; font-size:10pt; width: 58%">
            <tr>
                ...
                <td>#<?php echo Terbilang::make(abs($grand_total), ' rupiah'); ?>#</td>
            </tr>
            <tr>
                <td>Printed by : </td>
