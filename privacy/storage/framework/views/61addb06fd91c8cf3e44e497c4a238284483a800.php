                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_cashbank',null, ['class'=> 'form-control','style'=>'width: 100%' ,'id'=>'kode1','required', 'placeholder'=>'Kode Cash Bank','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_cashbank',null, ['class'=> 'form-control','style'=>'width: 100%' ,'id'=>'Kode2','required','readonly', 'onkeypress'=>"return pulsar(event,this)"])); ?>
