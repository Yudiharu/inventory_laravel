                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_transaksi', null, ['class'=> 'form-control','id'=>'Kode1', 'placeholder'=>'Kode Transaksi','required'=>'required','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_transaksi', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Transaksi','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
