                               ...
                               <!--   -->
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('kode_ukuran', $Ukuran,null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Ukuran1'])); ?>
                    ...
                    <div class="row">
                           ...
                           <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_ukuran', $Ukuran,null, ['class'=> 'form-control','id'=>'Ukuran2','required'=>'required'])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('partnumber',null, ['class'=> 'form-control','id'=>'Part2','required'=>'required','autocomplete'=>'off'])); ?>
        ...
        function show(id, url) {
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        $('#ukurans').html(result.kode_ukuran);
