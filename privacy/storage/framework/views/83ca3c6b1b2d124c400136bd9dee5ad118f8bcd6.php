<?php $__env->startSection('title', 'Laporan Transfer In'); ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Laporan <b>Transfer In</b></h4>
                </div>
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['route' => ['laporantransferin.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
    ...
    <script type="text/javascript">
        ...
        function cetakpdf() {
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    url:'<?php echo route('laporantransferin.export'); ?>',
                    type:'GET',
                    data:formData,
