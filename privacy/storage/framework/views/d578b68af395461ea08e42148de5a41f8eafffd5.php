...
<?php $__env->startSection('title', 'Recalculate'); ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Recalculate <b>Pemakaian</b></h4>
                </div>
                                ...
                                <div class="form-group">
                                   ...
                                   <div class="form-group">
                                       <label class="col-sm-3">
                                           ...
                                           <?php echo e(Form::selectYear('year', 2021, 2040, null, ['class'=> 'form-control select2','id'=>'namatahun','placeholder'=>'','style'=>'width: 100%'])); ?>
        ...
        $('#button1').click( function () {
            ...
            swal({
                    ...
                    showConfirmButton: false
                        ...
                        $.ajax({
                            url: '<?php echo route('recalculatepemakaian.change'); ?>',
                            type: 'POST',
                            data:formData,
