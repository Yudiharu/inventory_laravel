        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('penjualan.getkode'); ?>',
                        type:'POST',
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addpenjualan").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/penjualan/"+no_penjualan+"/detail");
                    var print = $("#printpenjualan").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/penjualan/exportpdf?no_penjualan="+no_penjualan);
                    var status = colom;
                    var item = colom2;
