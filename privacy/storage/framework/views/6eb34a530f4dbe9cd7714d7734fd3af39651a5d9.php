        ...
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-mobilor')) : ?>
                    ...
                    <span class="pull-right">  
                        <a href="https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/mobil/exportexcel?" target="_blank" id="printpembelian"><button type="button" class="btn bg-black btn-xs"><i class="fa fa-print"></i> CETAK LIST MOBIL</button></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('status_mobil', ['Aktif' => 'Aktif', 'NonAktif' => 'NonAktif'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Stat1','required'=>'required'])); ?>

                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group" style="color: red;">
                                    <?php echo e(Form::label('LabelInfo', 'Warning: Pemberian No Aset tidak boleh menggunakan spasi.')); ?>
    ...
    <div class="modal fade" id="editform" role="dialog">
                ...
                <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_jenis_mobil',$JenisMobil,null, ['class'=> 'form-control select2','id'=>'Jenis','required','placeholder'=>'','style'=>'width: 100%'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::selectYear('tahun', 2000, 2020, null, ['class'=> 'form-control','id'=>'Tahun','required'=>'required', 'autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_asset_mobil', null, ['class'=> 'form-control','id'=>'Asset','required'=>'required','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)", 'readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('status_mobil', ['Aktif' => 'Aktif', 'NonAktif' => 'NonAktif'], null, ['class'=> 'form-control','style'=>'width: 100%','id'=>'Stat','required'=>'required'])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <?php if (app('laratrust')->can('update-mobilora')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-mobilora')) : ?>
            ...
            <?php if (app('laratrust')->can('update-mobilor')) : ?>
            <a href="#" id="addlokasi"><button type="button" class="btn bg-black btn-xs add-button" data-toggle="modal" data-target="">EDIT LOKASI<i class="fa fa-plus"></i></button></a>
            <button type="button" class="btn btn-warning btn-xs edit-button" id="editmobil" data-toggle="modal" data-target="">EDIT <i class="fa fa-edit"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('delete-mobilor')) : ?>
            <button type="button" class="btn btn-danger btn-xs hapus-button" id="hapusmobil" data-toggle="modal" data-target="">HAPUS <i class="fa fa-times-circle"></i></button>
            <?php endif; // app('laratrust')->can ?>
