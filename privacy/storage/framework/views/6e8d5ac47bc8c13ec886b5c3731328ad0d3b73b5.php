...
$grand_total = round(($subtotal - $total_diskon) + $total_ppn + $pembelian->ongkos_kirim);
?>
<br>
<table class="grid" style="font-size: 10pt; width: 19cm; padding-top: 20px; padding-left: 15px; width: 92%" border="0" >
    <tr >
        <td  colspan="5" rowspan="5" style="font-size: 10pt; vertical-align: top; width: 60%">
            <strong>Terbilang : <br>
                <?php echo Terbilang::make($grand_total, ' rupiah'); ?>
            </strong>
        </td>
        <td width="16%" align="right">Subtotal </td>
        <td width="5%">Rp </td>
        <td align="right">
    ...
    <?php
        if ($total_diskon != 0) {
            if($pembelian->diskon_persen != 0) {?>
                <tr>
                    <td width="16%" align="right">Disc. (<?php echo $pembelian->diskon_persen ;?>%)</td>
                    <td width="5%">Rp</td>
                    <td align="right">
            ...
            <?php } 
                ...
                <tr>
                    <td width="16%" align="right">Disc.</td>
                    <td width="5%">Rp</td>
                    <td align="right">
                        <?php echo number_format($total_diskon,'0','.',',') ;?>
                    </td>
    ...
    <?php
        ...
        <tr>
            <td width="16%" align="right">Ongkos Kirim</td>
            <td width="5%">Rp</td>
            <td align="right">
    ...
    <?php } ?>
    <?php
        if ($total_diskon != 0 || $pembelian->ppn != 0 || $pembelian->ongkos_kirim != 0) {?>
        <tr>
            <td width="16%" align="right">Grand Total</td>
            <td width="5%">Rp</td>
            <td align="right">
...
<table class="grid" style="margin-top: 0px; padding-top: 5px; width: 19cm; padding-left: 15px" border="0">
    <tr>
