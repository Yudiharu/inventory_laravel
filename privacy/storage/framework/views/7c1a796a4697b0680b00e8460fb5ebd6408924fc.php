                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_vendor', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'NAMA VENDOR,CV','autocomplete'=>'off', 'style'=>"text-transform: uppercase;",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Contoh: NAMA VENDOR,CV"])); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_vendor_po', null, ['class'=> 'form-control','id'=>'Nama2','required'=>'required', 'placeholder'=>'CV. NAMA VENDOR','autocomplete'=>'off', 'style'=>"text-transform: uppercase;",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Contoh: CV. NAMA VENDOR"])); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_vendor', null, ['class'=> 'form-control','id'=>'Nama','required'=>'required', 'placeholder'=>'Contoh: NAMA VENDOR,CV','autocomplete'=>'off', 'style'=>"text-transform: uppercase;",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Contoh: NAMA VENDOR,CV", 'style'=>"text-transform: uppercase;"])); ?>
                        ...
                        <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_vendor_po', null, ['class'=> 'form-control','id'=>'Namapo','required'=>'required', 'placeholder'=>'Contoh: CV. NAMA VENDOR','autocomplete'=>'off', 'style'=>"text-transform: uppercase;",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Contoh: CV. NAMA VENDOR"])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_kontak', null, ['class'=> 'form-control','id'=>'Kontak','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
