...
<body>
    ...
    <div class="title">
    <h1>Memo-<?php echo e($memo->no_memo); ?></h1>
  ...
  <hr>
	<table rules="rows" class="grid" style="font-size: 10pt; vertical-align: top; width: 27cm" border="1">
            ...
            <?php $__currentLoopData = $memodetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td><?php echo e($rows->no_memo); ?></td>
