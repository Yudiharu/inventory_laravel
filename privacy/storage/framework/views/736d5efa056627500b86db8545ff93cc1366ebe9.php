...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-unit')) : ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_unit', null, ['class'=> 'form-control','id'=>'Kode1', 'placeholder'=>'Kode Unit','required'=>'required','autocomplete'=>'off','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 10 Karakter", 'maxlength'=>'10', 'onkeypress'=>"return pulsar(event,this)"] )); ?>

                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo e(Form::label('Nama Unit', 'Nama Unit:')); ?>

                                    <?php echo e(Form::text('nama_unit', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Unit', 'onkeypress'=>"return pulsar(event,this)",'autocomplete'=>'off'])); ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                    <div class="row">
                        <div class="col-md-9">
                            <div class="form-group">
                                <?php echo e(Form::label('Kode Unit', 'Kode Unit:')); ?>

                                <?php echo e(Form::text('kode_unit', null, ['class'=> 'form-control','id'=>'Kode2','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)", 'readonly'])); ?>
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_unit', null, ['class'=> 'form-control','id'=>'Nama2','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
...
<!--                         <div class="col-md-3">
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-unit')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-unit')) : ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#editunit').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('unit.edit_unit'); ?>',
                    type: 'POST',
                    data : {
                        'kode_unit': id
                    },
            ...
            $('#hapusunit').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('unit.hapus_unit'); ?>',
                            type: 'POST',
                            data : {
                                'kode_unit': id
                            },
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('unit.ajaxupdate'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#editform').modal('hide');
