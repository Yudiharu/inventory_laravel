                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('kode_satuan', null, ['class'=> 'form-control','id'=>'Kode1', 'placeholder'=>'Kode Satuan'])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_satuan', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Satuan'])); ?>
            ...
            <div class="modal-body">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_satuan', null, ['class'=> 'form-control','id'=>'Nama2'])); ?>
