    ...
    <section class="list-item">
        <table class="grid" style="font-size: 10pt; width: 19cm;" border="0" >
            ...
            <?php foreach ($pembeliandetail as $key => $value): ?>
                    ...
                    <?php
                    $item_length = strlen($value->nonstock->nama_item) ;
                    if ($item_length > 26){
                        $limit_row += 1;
                    }
                    ?>
            ...
            <tr >
                <td >1</td>
                <td >LIST BARANG DI LEMBAR KE 2</td>
                <td><?php echo $subqty ?></td>
...
$total_ppn = (($subtotal - $total_diskon) + $total_pbbkb + $pembelian->ongkos_angkut)*($pembelian->ppn / 100);
...
<div class="footer" style="font-size: 10pt;padding-top: 0.9cm">
    <div class="tgl">
        ...
        <table id="yay" class="grid1" width="100%" style="margin-left:0px; font-size: 11px">
            ...
            <?php foreach ($pembeliandetail as $key => $value): ?>
                <tr style="vertical-align:top">
                    ...
                    <td ><?php echo $value->nonstock->nama_item ?></td>
                    <td align="center">
                        <?php
