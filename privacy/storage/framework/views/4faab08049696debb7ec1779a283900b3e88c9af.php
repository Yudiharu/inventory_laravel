                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_lokasi', null, ['class'=> 'form-control','id'=>'id1', 'placeholder'=>'ID Lokasi','required'=>'required','autocomplete'=>'off','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 6 Karakter", 'maxlength'=>'6', 'style'=>"text-transform: uppercase;"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_lokasi', null, ['class'=> 'form-control','id'=>'nama1','required'=>'required', 'placeholder'=>'Nama Lokasi', 'style'=>"text-transform: uppercase;",'autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::textArea('alamat', null, ['class'=> 'form-control','rows'=>4,'id'=>'alamat1','required'=>'required', 'placeholder'=>'Alamat','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_lokasi', null, ['class'=> 'form-control','id'=>'Nama2','required'=>'required','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php echo e(Form::label('Alamat', 'Alamat:')); ?>
                                    ...
                                    <?php echo e(Form::textArea('alamat', null, ['class'=> 'form-control','rows'=>4,'id'=>'Alamat2','required'=>'required','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
