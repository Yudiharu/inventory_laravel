...
<?php $__env->startSection('title', 'Laporan Pemakaian Produk'); ?>
        ...
        <div class="modal fade" id="button4"  role="dialog">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <?php echo Form::open(['route' => ['laporanpemakaianproduk.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">  
                                <?php echo e(Form::label('pilih', 'Tipe Pemakaian:')); ?>              
                                <?php echo e(Form::select('tipe_pemakaian', ['alat' => 'Alat', 'mobil' => 'Mobil', 'kapal' => 'Kapal', 'Other' => 'Other'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'report1','required'=>'required'])); ?>

                            </div>
                            <div class="col-sm-12">
                                <div class="form-group"> 
                                    <?php echo e(Form::label('prod', 'Nama Produk:')); ?>              
                                    <?php echo e(Form::select('kode_produk', $Produk, null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Produk1','required'=>'required'])); ?>

                                </div>
                            </div>
                            <?php echo e(Form::hidden('status', 'POSTED', ['class'=> 'form-control','id'=>'status1','readonly'])); ?>
    ...
    <script type="text/javascript">
        ...
        function cetakpdf() {
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    url:'<?php echo route('laporantransferout.export'); ?>',
                    type:'GET',
                    data:formData,
