                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nopol', null, ['class'=> 'form-control','id'=>'Nopol1','required'=>'required', 'placeholder'=>'No. Polisi'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_jenis_mobil', $JenisMobil, null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'Pilih','id'=>'Jenis1','required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_asset', null, ['class'=> 'form-control','id'=>'Asset1','required'=>'required', 'placeholder'=>'No. Asset'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('id_lokasi', $lokasi,null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => 'Pilih','id'=>'Lokasi1',
                                    'required'=>'required'])); ?>
                ...
                <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nopol', null, ['class'=> 'form-control','id'=>'Nopol','required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_jenis_mobil',$JenisMobil,null, ['class'=> 'form-control','id'=>'Jenis','required'=>'required'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_asset', null, ['class'=> 'form-control','id'=>'Asset','required'=>'required'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        $('#ADD').submit(function (e) {
            ...
            if (nopol === ''|| jenis === ''|| asset === ''|| lokasi === '') {
                    // if(kode === ''){
                    //     $( '.kode-error' ).html('Mohon di Isi');
                    // }
                    if(nopol === ''){
                        $( '.nopol-error' ).html('Mohon di Isi');
                    }
                    if(jenis === ''){
                    ...
                    if(lokasi === ''){
                        $( '.lokasi-error' ).html('Mohon di Isi');
                    }
        ...
        $('#EDIT').submit(function (e) {
            ...
            // Check if empty of not
            if (kode === '' || nopol === ''|| jenis === ''|| asset === ''|| lokasi === '') {
                alert('Mohon Lengkapi Form Isian');
                return false;
            }else{
                $.ajax({
