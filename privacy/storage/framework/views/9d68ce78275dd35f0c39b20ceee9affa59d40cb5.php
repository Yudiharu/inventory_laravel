        ...
        <div class="box-body">
            <div class="box ">
             ...
             <table class="table table-bordered table-striped table-hover" id="kapal-table" width="100%" style="font-size: 12px;">
                <thead>
                <tr class="bg-blue" style="font-size: 10px;">
                    <th>Kode kapal</th>
                    <th>Nama kapal</th>
                    <th>Merk</th>
                    <th>Type</th>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::label('Type', 'Tipe Kapal:',['class'=>'control-label'])); ?>
                                        ...
                                        <?php echo e(Form::select('type', ['MV'=>'MV','KM'=>'KM','Tug Boat'=>'Tug Boat'],null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Nama3'])); ?>
                            ...
                            <!-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kapasitas', null, ['class'=> 'form-control','id'=>'kapasitas1', 'placeholder'=>'Kapasitas (Ton)', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Info: angka dalam ton"])); ?>
                            ...
                            <!-- <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('kode_time_sheet', 'Kode Time Sheet:')); ?>

                                    <?php echo e(Form::text('kode_time_sheet', null, ['class'=> 'form-control','id'=>'kodetime1', 'placeholder'=>'kode time sheet', 'autocomplete'=>'off','onkeypress'=>"return pulsar(event,this)"])); ?>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::label('Type', 'Tipe Kapal:',['class'=>'control-label'])); ?>
                                        ...
                                        <?php echo e(Form::select('type', ['MV'=>'MV','KM'=>'KM','Tug Boat'=>'Tug Boat'],null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'Tipe2'])); ?>
                    ...
                    <!-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kapasitas', null, ['class'=> 'form-control','id'=>'kapasitas2', 'placeholder'=>'Kapasitas (Ton)', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)",'data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Info: angka dalam ton"])); ?>
