...
<body>
    ...
    <div class="title">
    <h1>No Pembelian: <?php echo e($pembelian->no_pembelian); ?></h1>
    <p><b>Nama Vendor: <?php echo e($pembelian->vendor->nama_vendor); ?></b></p>
  ...
  <hr>
	<table rules="rows" class="grid" style="font-size: 10pt; vertical-align: top; width: 27cm" border="1">
            ...
            <tbody>
            <?php $__currentLoopData = $pembeliandetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td><?php echo e($rows->no_pembelian); ?></td>
