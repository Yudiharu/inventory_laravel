                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('type_ar', ['Jasa' => 'Jasa','Sparepart' => 'Sparepart','Unit' => 'Unit'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Typear','required'=>'required'])); ?>
                            ...
                            <!-- <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('status', ['Aktif' => 'Aktif', 'NonAktif' => 'NonAktif'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Status','required'=>'required'])); ?>
    ...
    function pulsar(e,obj) {            
        ...
        $(function() {          
            ...
            columns: [
                ...
                // { data: 'seri_faktur', name: 'seri_faktur' },
                // { data: 'top', name: 'top' },
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        if(result.title == 'Gagal'){
                            ...
                            for (var i = 0; i < len; i++) {
                                console.log(result[i].produk,result[i].partnumber,result[i].satuan,result[i].qty,result[i].harga);
                            }
