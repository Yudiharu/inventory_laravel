<?php $__env->startSection('title', 'Disassembling Detail'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Disassembling <b><?php echo e($disassembling->produk->nama_produk); ?></b></font>
    </span>
    ...
    <div class="box box-info">
        <div class="box-body"> 
                <div class="addform">
                    ...
                    <div class="row">
                        <?php echo e(Form::hidden('id',$disassembling->id, ['class'=> 'form-control','readonly','id'=>'id_dis'])); ?>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <?php echo e(Form::label('harga', 'HPP Saat Ini:')); ?>

                                <?php echo e(Form::text('harga',null, ['class'=> 'form-control','id'=>'Harga','readonly'])); ?>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('hpp', null, ['class'=>'form-control','required'=>'required','id'=>'hpp','autocomplete'=>'off'])); ?>
            ...
            <div class="editform">
                ...
                <?php echo Form::open(['id'=>'UPDATE_DETAIL']); ?>
                 ...
                 <center><kbd>EDIT FORM</kbd></center><br>
                    <div class="row">   
                            <?php echo e(Form::hidden('id',$disassembling->id, ['class'=> 'form-control','readonly','id'=>'id_dis1'])); ?>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('qty', null, ['class'=> 'form-control','id'=>'QTY_e','required','autocomplete'=>'off'])); ?>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('hpp',null, ['class'=> 'form-control','id'=>'Harga_e','required'=>'required'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        var id = $('#id_dis').val();
            ...
            processing: true,
            serverSide: true,
            ajax:'http://localhost/gui_inventory_laravel/admin/disassemblingdetail/getDatabyID?id='+id,
            data:{'id':id},
  ...
  <script>
        ...
        function getharga(){
            ...
            $.ajax({
                url:'<?php echo route('disassemblingdetail.getharga'); ?>',
                type:'POST',
                data : {
                    'id': kode_produk,
                    'part': partnumber,
        ...
        function editpart(){
            ...
            $.ajax({
                url: "<?php echo route('disassemblingdetail.selectpart'); ?>",
                method: 'POST',
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'<?php echo route('disassemblingdetail.store'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            // Check if empty of not
                $.ajax({
                    url:'<?php echo route('disassemblingdetail.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
