        ...
        <div class="right">
            <table style="float: right; font-size: 10pt" border="0">
                <tr>
                    ...
                    <td style="width: 10px">:</td>
                    <td><?php echo date_format($assembling->created_at,"d/m/Y") ?></td>
                </tr>
                <tr>
                    <td >Reference</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Status</td>
                    <td>:</td>
                    <td><?php echo e($assembling->status); ?></td>
                </tr>
            </table>
        </div>
    </div>
...
<div class="content">
    ...
    <div class="left">
        <table width="50%" style="  font-size: 10pt" border="0">
            <tr >
                ...
                <td style="width: 310px">Account Name</td>
    ...
    <div class="left">
        <table style="padding-left:0mm; font-size:10pt" border="0">
            ...
            <?php foreach ($ledger as $key => $value): ?>
                <tr >
                    ...
                    <td style="width: 310px"><?php echo $value->ac_description ?></td>
    ...
    <div class="left">
        <table width="100%" style="  font-size: 10pt" border="0">
            <tr >
                ...
                <td style="width: 130px; text-align: right"><?php echo number_format($grand_total1,'0','.',',') ?></td>
