                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::selectYear('year', 2019, 2040, null, ['class'=> 'form-control select2','id'=>'namatahun','required'=>'required', 'placeholder'=>'','style'=>'width: 100%'])); ?>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('kategori', ['SEMUA'=>'SEMUA','Kategori'=>$kategori], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'kategori1','required'=>'required'])); ?>
