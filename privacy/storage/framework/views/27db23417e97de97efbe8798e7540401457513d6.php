<?php $__env->startSection('title', 'Pemakaian Create'); ?>
...
<body onload="load()">
    ...
    <div class="box box-success">
        <div class="box-body">
                    ...
                    <div class="row"> 
                        <div class="col-md-12">
                            <div class="pull-right"><?php echo e(Form::submit('Create Pemakaian', ['class' => 'btn btn-success','id'=>'addsubmit'])); ?></div>
                        </div>
                    </div>
                    <?php echo Form::close(); ?>
                    ...
                    <div class="row form-detail">
                        <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <?php echo Form::open(['route' => ['pemakaiandetail.multistore'],'method' => 'post','id'=>'form-detail-p','role'=>'form']); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <table class="table table-striped table-bordered" id="tblAddRow">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo e(Form::text('no_pemakaian[]',null, ['class'=> 'form-control','readonly','id'=>'Pemakaian'])); ?>
                            ...
                            <div class="box-footer form-detail">
                                    ...
                                    <?php echo e(Form::submit('Finish', ['class' => 'btn btn-success'])); ?>
...
$('#Addform').submit(function (e) {
            ...
            var addsubmit = document.getElementById("addsubmit");
                $.ajax({
                    url:'<?php echo route('pemakaian.addstore'); ?>',
                    type:'POST',
                    data:formData,
