                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_lokasi', null, ['class'=> 'form-control','id'=>'Nama2','required'=>'required','readonly'])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nickname', null, ['class'=> 'form-control','id'=>'Nick2','required'=>'required','readonly'])); ?>
