...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>LAPORAN DATA RETUR PEMBELIAN BARANG</title>
    <style>
        .header, h1 {
            font-size: 11pt;
            margin-bottom: 0px;
...
<div class="fixed-header">
        ...
        <br><br>
            <h1>LAPORAN RETUR PEMBELIAN BARANG</h1>
...
?>
    <table class="grid1" style="margin-bottom: 25px;width: 100%; font-size: 11px">
        ...
        <tbody>
            <?php $__currentLoopData = $returbelidetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <tr class="border">
                <td><?php echo $key+1 ?></td>
                <td><?php echo $row->no_returpembelian?></td>
                <td><?php echo $row->no_pembelian?></td>
                <td><?php echo $row->no_penerimaan?></td>
                <td><?php echo $row->tanggal_returpembelian?></td>
