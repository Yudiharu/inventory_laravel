...
?>
    <table class="grid1" style="margin-bottom: 25px;width: 100%; font-size: 11px">
        ...
        <tbody>
            <?php $__currentLoopData = $opnamedetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
