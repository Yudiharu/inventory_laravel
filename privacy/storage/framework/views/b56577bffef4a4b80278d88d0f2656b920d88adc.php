                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('tipe', ['Baru' => 'Baru', 'Cabang' => 'Cabang'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'tipe1','required'=>'required','onchange'=>"tipes();"])); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_company', null, ['class'=> 'form-control','id'=>'Nama','readonly'])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="number" style="display:none;">
                                <?php echo e(Form::text('npwp', null, ['class'=> 'form-control','id'=>'Npwp', 'name'=>'npwp'])); ?>
