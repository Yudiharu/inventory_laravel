...
<div class="header">
    <h1>LAPORAN DATA TRANSFER IN BARANG</h1>
...
?>
    <table class="table_content" style="margin-bottom: 25px;width: 100%;">
        ...
        <?php foreach ($transferindetail as $key => $row) : ?>
        <tbody>
        ...
        ?>
            ...
            <tr class="border">
                ...
                <td class="border" align="right"><?php echo number_format($row->hpp,'0',',','.') ?></td>
                <td class="border" align="right"><?php echo number_format($row->hpp * $row->qty,'0',',','.') ?></td>
        ...
        <tfoot>
        <tr class="border">
            <td class="border" colspan="11" style="font-weight: bold">Total</td>
