...
<head>
    ...
    <br>
    <title>Laporan Opname ~ <?php echo e($no_opname); ?></title>
    <style>
        .header, h1 {
            font-size: 11pt;
            margin-bottom: 0px;
...
<div class="fixed-header">
        ...
        <br><br>
            <h1>LAPORAN OPNAME <?php echo e($no_opname); ?></h1>
            <p>Tanggal Opname: <?php echo $tgl ?> | Status: <?php echo e($status); ?></p>
        ...
        <table id="yay" class="grid1" width="100%" style="margin-left:0px; font-size: 11px">
            ...
            <?php foreach ($opnamedetail as $key => $value): ?>
                <tr >
                    ...
                    <td><?php echo e(number_format($value->stock_opname,'0','.',',')); ?></td>
                    <?php if (app('laratrust')->can('read-hpp')) : ?>
                    <td><?php echo e(number_format($value->amount_opname,'0','.',',')); ?></td>
                    <td><?php echo e(number_format($value->hpp,'0','.',',')); ?></td>
                    <?php endif; // app('laratrust')->can ?>
                    <?php
