        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addopname").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_sub_laravel_trial/admin/opname/"+no_pembelian+"/detail");
                    var print = $("#printopname").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_sub_laravel_trial/admin/opname/exportpdf?no_opname="+no_pembelian);
                    var status = colom;
                    var item = colom2;
