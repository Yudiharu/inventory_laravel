        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray') ) {
                    ...
                    var add = $("#addadjustment").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_sub_laravel/admin/adjustment/"+no_penyesuaian+"/detail");
                    var print = $("#printadjustment").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_sub_laravel/admin/adjustment/exportpdf?no_penyesuaian="+no_penyesuaian);
                    var status = colom;
                    var item = colom2;
