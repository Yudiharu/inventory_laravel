...
<?php use App\Models\Produk; ?>
    <title>WORK ORDER (WO) ~ <?php echo e($request); ?></title>
    <style>
        @page  {
    ...
    <div class="left">
        <table width="40%" style="  font-size: 10pt" border="0">
            <tr >
                ...
                <td><?php echo e($work->no_wo); ?></td>
            </tr>
            <tr >
                <td style="width: 100px">Date In</td>
                <td style="width: 10px">:</td>
                <td><?php echo e($work->date_in); ?></td>
            </tr>
            <tr>
                <td >Lokasi</td>
                <td>:</td>
                <td style="font-size: 9pt"><?php echo e($work->kode_lokasi); ?></td>
            </tr>
        </table>
    </div>
    <div class="right">
        <table width="51%" style="font-size: 10pt; padding-left: 150px" border="0">
            <tr >
                ...
                <td style="width: 10px">:</td>
                <td><?php echo e($work->no_reff); ?></td>
            </tr>
            <tr>
                <td style="width: 100px">Date Finish</td>
                <td style="width: 10px">:</td>
                <td><?php echo e($work->date_finish); ?></td>
            </tr>
            <tr>
                <td>Kode Tagging</td>
                <td>:</td>
                <td><?php echo e($work->no_asset_alat); ?></td>
            </tr>
        </table>
    </div>
</div>
