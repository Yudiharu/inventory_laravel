...
<head>
    ...
    <br>
    <title>Laporan Penjualan ~ <?php echo e($no_penjualan); ?></title>
    <style>
        @page  {
...
<div class="header">
    <div class="left">
        <table width="50%" style="font-size: 10pt" border="0">
            <tr>
                <td style="width: 180px">Tipe Ar</td>
    ...
    <div class="right">
        <table width="50%" style="padding-left:8em; font-size: 10pt" border="0">
            <tr>
                <td style="width: 180px">No. Penjualan</td>
                <td style="width: 10px">:</td>
                <td><?php echo e($no_penjualan); ?></td>
            </tr>
            <tr>
...
<div class="content">
    <section class="list-item">
        <table style="font-size: 10pt; width: 19cm;" border="0" >
            ...
            <?php foreach ($penjualandetail as $key => $value): ?>
                <tr >
            ...
            $total_row = count($penjualandetail);
            $max_row = (9 - $limit_row) ;
