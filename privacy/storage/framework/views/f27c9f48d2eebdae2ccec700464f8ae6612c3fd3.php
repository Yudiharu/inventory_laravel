...
<table class="grid" style="font-size: 10pt; width: 20cm; padding-top: 30px; padding-left: 12px" border="0" >
    <tr >
        <td  colspan="5" rowspan="5" style="font-size: 10pt; vertical-align: top; width: 50%">
            <strong>Terbilang : <br>
...
<table class="grid" style="margin-top: 0px; padding-top: 20px; padding-left: 12px; width: 19cm" border="0">3
    <tr>
        <br>
