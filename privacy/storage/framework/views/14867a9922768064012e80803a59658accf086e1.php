                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group7">
                                    <?php echo e(Form::label('kode_lokasi', 'Kode Lokasi:')); ?>

                                    <?php echo e(Form::select('kode_lokasi', $Lokasi->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'lokasi1'])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group7">
                            ...
                            <?php echo e(Form::select('kode_lokasi', $Lokasi->sort(), null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'lokasi'])); ?>
