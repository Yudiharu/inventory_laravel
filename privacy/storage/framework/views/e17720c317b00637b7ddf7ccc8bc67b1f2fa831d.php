...
<br><br>
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo e(url(config('adminlte.dashboard_url', 'home'))); ?>"><font style="color: black; text-shadow: 0 0 10px #fff, 0 0 20px #fff, 0 0 30px #30DBDB, 0 0 40px #30DBDB, 0 0 50px #30DBDB, 0 0 60px #30DBDB, 0 0 70px #30DBDB;"><?php echo config('adminlte.logo', '<b>Admin</b>LTE'); ?></font></a>
        </div>
        <!-- /.login-logo -->
