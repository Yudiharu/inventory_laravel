                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('show', ['Produk' => 'Produk', 'Kategori' => 'Kategori'], null, ['class'=> 'form-control select2','style'=>'width: 100%','id'=>'history','required'=>'required','onchange'=>"pilih();"])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('tanggal_akhir',\Carbon\Carbon::now(), ['class'=> 'form-control','id'=>'tanggal1','placeholder'=>'Tanggal Akhir'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?php echo e(Form::label('formatcetak', 'Format Cetak:')); ?>
