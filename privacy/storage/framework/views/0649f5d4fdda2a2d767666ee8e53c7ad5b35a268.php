        ...
        <div class="box-body">
            <div class="box box-info">
                <div class="box-body">
                    ...
                    <a href="<?php echo e(route('permissions.index')); ?>" class="btn btn-default btn-sm" onclick="refreshTable()">Manages Permission</a>
                </div>
            </div>
            <?php echo $dataTable->table(['class' => 'table table-bordered table-hover'], true); ?>
