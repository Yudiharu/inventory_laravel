...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail Memo <b><?php echo e($memo->no_memo); ?></b></font>
    </span>
                        ...
                        <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_memo',$memo->no_memo, ['class'=> 'form-control','readonly','id'=>'nomemo'])); ?>
                            ...
                            <div class="row">   
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('no_memo',$memo->no_memo, ['class'=> 'form-control','readonly','id'=>'nomemo2'])); ?>

                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <?php echo e(Form::label('kode_produk', 'Nama Produk:')); ?>

                                        <?php echo e(Form::select('kode_produk',$Produk->sort(),null,['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'produk2'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        //     $.ajax({
        //         url:'<?php echo route('memodetail.stockproduk'); ?>',
        //         type:'POST',
        //         data : {
        //                 'id': kode_produk,
        //                 'no': no_pembelian
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            $.ajax({
                    url:'<?php echo route('memodetail.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                $.ajax({
                    url:'<?php echo route('memodetail.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#QTY2').val('');
