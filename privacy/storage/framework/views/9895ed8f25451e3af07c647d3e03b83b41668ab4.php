                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('kode_satuan', null, ['class'=> 'form-control','id'=>'Kode1'])); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_satuan', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required'])); ?>
            ...
            <div class="modal-body">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('kode_satuan', null, ['class'=> 'form-control','id'=>'Kode'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_satuan', null, ['class'=> 'form-control','id'=>'Nama'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('status', 'Status:')); ?><br>
                            <?php echo e(Form::select('status', ['1' => 'Aktif', '0' => 'Non Aktif'], null, ['class'=> 'form-control','id'=>'Status'])); ?>
