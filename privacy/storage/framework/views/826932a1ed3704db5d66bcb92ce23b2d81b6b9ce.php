                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::text('nama_ukuran', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Ukuran','autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_ukuran', null, ['class'=> 'form-control','id'=>'Nama','required'=>'required', 'style'=>"text-transform: uppercase;"])); ?>
