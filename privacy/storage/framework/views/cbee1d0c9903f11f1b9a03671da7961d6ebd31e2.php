...
<div class="header">
    <h1>LAPORAN DATA ADJUSTMENT BARANG</h1>
...
?>
    <table class="table_content" style="margin-bottom: 25px;width: 100%;">
        ...
        <tr class="border" style="background-color: #e6f2ff">
            ...
            <th class="border" width="">No Adjustment</th>
        ...
        <?php foreach ($adjustmentdetail as $key => $row) : ?>
        <tbody>
        ...
        ?>
            ...
            <tr class="border">
                ...
                <td class="border" align="left"><?php echo $row->no_penyesuaian?></td>
                <td class="border" align="left"><?php echo $row->tanggal?></td>
