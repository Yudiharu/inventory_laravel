                ...
                <div class="col-md-6">
                   <div class="box">
                       ...
                       <div class="box-body">
                           ...
                           <div class="form-group">
                               <label class="col-sm-8">
                                   <?php echo e(Form::selectYear('year', 2019, 2040, null, ['class'=> 'form-control select3','id'=>'namatahun','placeholder'=>'','style'=>'width: 100%'])); ?>
                ...
                <div class="col-md-6">
                    <div class="box">
                        ...
                        <div class="box-body">
                           ...
                           <div class="form-group">
                               <label class="col-sm-8">
                                   <?php echo e(Form::selectYear('year2', 2019, 2040, $info_tahun, ['class'=> 'form-control select3','id'=>'namatahun2','placeholder'=>'','style'=>'width: 100%'])); ?>
