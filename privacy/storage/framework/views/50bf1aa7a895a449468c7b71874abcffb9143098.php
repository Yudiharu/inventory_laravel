...
<?php $__env->startSection('content'); ?>
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Edit Produk : <?php echo e($pemakaian->no_pemakaian); ?></h3>
            <!-- /.box-tools -->
        </div>
        <!-- /.box-header -->
        <div class="box-body">
        ...
        <div class="box box-success">
            ...
            <?php echo Form::model($pemakaian, ['route' => ['pemakaian.update', $pemakaian->no_pemakaian],'method' => 'patch']); ?>

                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('No Pemakaian', 'No Pemakaian:')); ?>

                            <?php echo e(Form::text('no_pemakaian', null, ['class'=> 'form-control'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('tanggal_pemakaian', null, ['class'=> 'form-control'])); ?>
