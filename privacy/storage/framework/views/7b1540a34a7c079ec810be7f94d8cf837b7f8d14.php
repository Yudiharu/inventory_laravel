                ...
                <?php echo Form::open(['route' => ['laporanproduk.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <?php echo e(Form::label('merr', 'Merek:')); ?>

                                        <?php echo e(Form::select('merek', ['SEMUA'=>'SEMUA',$merek], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'merek1','required'=>'required'])); ?>
