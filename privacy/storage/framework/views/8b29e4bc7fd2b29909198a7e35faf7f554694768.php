          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <!--<div class="col-md-4">-->
                                <!--    <div class="form-group">-->
                                <!--        <?php echo e(Form::label('satuan_terbesar', 'Satuan Terbesar:')); ?>-->
                                <!--        <?php echo e(Form::text('satuan_terbesar',null, ['class'=> 'form-control','readonly','id'=>'Terbesar2'])); ?>-->
                                <!--    </div>-->
                                <!--</div>-->
                                ...
                                <!--<div class="col-md-4">-->
                                <!--    <div class="form-group">-->
                                <!--        <?php echo e(Form::label('kode_satuanterkecil', 'Satuan Terkecil:')); ?>-->
                                <!--        <?php echo e(Form::text('kode_satuanterkecil', null, ['class'=> 'form-control','readonly','id'=>'Kode_Terkecil2'])); ?>-->
                                <!--    </div>-->
                                <!--</div>-->
