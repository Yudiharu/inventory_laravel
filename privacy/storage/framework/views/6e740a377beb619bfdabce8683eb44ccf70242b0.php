<?php $__env->startSection('title', 'Calculate Pemakaian Ban'); ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Calculate <b>Pemakaian Ban</b></h4>
                </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        $('#button1').click( function () {
            ...
            swal({
                    title: "<b>Check Pemakaian Ban 1/3.</b>",
            ...
            $.ajax({
              url: '<?php echo route('checkpemakaianban.change'); ?>',
              type: 'POST',
              data:{
                  'index': index,
                  'periode': periode,
        ...
        function changenext(){
          ...
          var formData = registerForm.serialize();
          swal({
            title: "<b>Check Pemakaian Ban 2/3.</b>",
            text: "Mohon Tunggu Hingga Proses Selesai.",
            type: "warning",
            showCancelButton: false,
            showConfirmButton: false
        ...
        function changenext2(){
          ...
          var formData = registerForm.serialize();
          swal({
            title: "<b>Check Pemakaian Ban 3/3.</b>",
            text: "Mohon Tunggu Hingga Proses Selesai.",
            type: "warning",
            showCancelButton: false,
            showConfirmButton: false
