                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('jenis_po', ['Stock' => 'Stock','Jasa' => 'Jasa','Non-Stock' => 'Non-Stock'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Jenis1','required'=>'required','onchange'=>"getnama();"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('No Alat', 'No Alat:')); ?>

                                    <?php echo e(Form::text('no_alat', null, ['class'=> 'form-control','id'=>'Alat1','autocomplete'=>'off','readonly'])); ?>
                            ...
                            <?php if (Auth()->user()->kode_company == '03' || Auth()->user()->kode_company == '04' || Auth()->user()->kode_company == '0401'){ ?>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?php echo e(Form::label('Costor', 'Cost Center:')); ?>

                                        <?php echo e(Form::select('cost_center',$Costcenter->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Cost1'])); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::textarea('deskripsi', null, ['class'=> 'form-control','rows'=>'2','id'=>'Deskripsi1', 'placeholder'=>'Deskripsi', 'autocomplete'=>'off', 'required','onkeypress'=>"return pulsar(event,this)"])); ?>
                            ...
                            <!--<div class="col-md-12">-->
                            <!--    <div class="form-group">-->
                            <!--        <?php echo e(Form::label('keterangan_cetak', 'Keterangan Detail PO (isi apabila total item PO tidak cukup 1 halaman):')); ?>-->
                            <!--        <?php echo e(Form::textarea('keterangan_cetak', null, ['class'=> 'form-control','rows'=>'2','id'=>'Keterangan1', 'placeholder'=>'Keterangan', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>-->
                            <!--     </div>-->
                            <!--</div> -->
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('jenis_po', ['Stock' => 'Stock','Jasa' => 'Jasa','Non-Stock' => 'Non-Stock'], null, ['class'=> 'form-control select2','style'=>'width: 100%','id'=>'Jenis','readonly'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('kode_vendor',$Vendor,null, ['class'=> 'form-control select2','style'=>'width: 100%','id'=>'Vendor','onchange'=>'get_ppn2()'])); ?>
                            ...
                            <?php if (Auth()->user()->kode_company == '03' || Auth()->user()->kode_company == '04' || Auth()->user()->kode_company == '0401'){ ?>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('cost_center',$Costcenter->sort(),null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Cost2'])); ?>
                            ...
                            <?php } ?>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::textarea('deskripsi', null, ['class'=> 'form-control','rows'=>'4','id'=>'Deskripsi', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        function tablepreview(kode){
            $.ajax({
                url: '<?php echo route('pembelian.getDatapreview'); ?>',
                type: 'GET',
                data : {
                    'id': kode
                },
        ...
        function limiter() {
            $.ajax({
                url: '<?php echo route('pembelian.limitos'); ?>',
                type: 'GET',
                data : {
                },
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    $.ajax({
                        url: '<?php echo route('pembelian.previewpo'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_pembelian
                        },
                    ...
                    $.ajax({
                        url: '<?php echo route('pembelian.historia'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_pembelian
                        },
            ...
            $('#button7').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('pembelian.approve'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembelian
                            },
            ...
            $('#button8').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('pembelian.disapprove'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembelian
                            },
            ...
            $(document).on('click', '#btn-save', function() {
                ...
                var no_pembelian = data['no_pembelian'];
                $.ajax({
                    url: '<?php echo route('pembelian.ttd_buat'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_pembelian,
                        'img': img,
            ...
            $(document).on('click', '#btn-periksa', function() {
                ...
                var no_pembelian = data['no_pembelian'];
                $.ajax({
                    url: '<?php echo route('pembelian.ttd_periksa'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_pembelian,
                        'img': img,
            ...
            $(document).on('click', '#btn-setuju', function() {
                ...
                var no_pembelian = data['no_pembelian'];
                $.ajax({
                    url: '<?php echo route('pembelian.ttd_setuju'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_pembelian,
                        'img': img,
            ...
            $(document).on('click', '#btn-tahu', function() {
                ...
                var no_pembelian = data['no_pembelian'];
                $.ajax({
                    url: '<?php echo route('pembelian.ttd_tahu'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_pembelian,
                        'img': img,
            ...
            $('#voidpembelian').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('pembelian.void_pembelian'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembelian
                            },
