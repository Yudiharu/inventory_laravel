...
<body>
    <div class="fixed-header">
        ...
        <br><br>
            <h1><?php echo e($jurnal->nama_jurnal); ?></h1>
        <br>
        ...
        <div class="left">
            <table width="50%" style="float: left; font-size: 10pt" border="0">
                <tr >
                    ...
                    <td><?php echo e($ledger2->no_journal); ?></td>
                </tr>
                <tr>
                    <td >Journal Date</td>
                    <td>:</td>
                    <td><?php echo e($journal_date); ?></td>
                </tr>
                <tr>
                    <td >Remark</td>
                    <td>:</td>
        ...
        <div class="right">
            <table style="float: right; font-size: 10pt" border="0">
                <tr>
                    ...
                    <td style="width: 10px">:</td>
                    <td><?php echo date_format($pemakaian->created_at,"d/m/Y") ?></td>
                </tr>
                <tr>
                    <td >Reference</td>
                    <td>:</td>
                    <td><?php echo e($ledger2->reference); ?></td>
                </tr>
                <tr>
                    <td>Status</td>
                    <td>:</td>
                    <td><?php echo e($pemakaian->status); ?></td>
                </tr>
            </table>
        </div>
    </div>
...
<div class="content">
    ...
    <div class="left">
        ...
        <?php if (Auth()->user()->kode_company == '03') { ?>
            <tr>
                <td style="width: 85px">Cost Center</td>
                <td style="width: 33px">D/K</td>
                <td style="width: 164px">Account No.</td>
                <td style="width: 250px">Account Name</td>
    ...
    <div class="left">
        <table style="padding-left:0mm; font-size:10pt">
            ...
            <?php foreach ($ledger as $key => $value): ?>
                <?php if (Auth()->user()->kode_company == '03') { ?>
                    <tr>
                        <?php if ($value->cost_center != null) { ?>
                            <?php $cost = Costcenter::find($value->cost_center); ?>
                            <td style="width: 85px"><?php echo $cost->cost_center.'-'.$cost->desc ?></td>
                        <?php }else { ?>
                            <td style="width: 85px">-</td>
                        <?php } ?>
                        <td style="width: 33px"><?php echo $value->db_cr ?></td>
                        <td style="width: 164px"><?php echo $value->account ?></td>
                        <td style="width: 250px"><?php echo $value->ac_description ?></td>
                        <td style="width: 130px; text-align: right"><?php echo number_format($value->debit,'2','.',',') ?></td>
                        <td style="width: 130px; text-align: right"><?php echo number_format($value->kredit,'2','.',',') ?></td>
                    </tr>
                <?php }else { ?>
                    <tr>
    ...
    <div class="left">
        <table width="100%" style="  font-size: 10pt" border="0">
            <tr >
                <?php if (Auth()->user()->kode_company == '03') { ?>
                    <td style="width: 477px">TOTAL JOURNAL</td>
                <?php }else { ?>
                    <td style="width: 537px">TOTAL JOURNAL</td>
                <?php } ?>
                <td style="width: 130px; text-align: right"><?php echo number_format($grand_total,'2','.',',') ?></td>
                <td style="width: 130px; text-align: right"><?php echo number_format($grand_total,'2','.',',') ?></td>
            </tr>
        </table>
    </div>
    ...
    <div class="left">
        <table style="padding-left:1mm; font-size:10pt; width: 58%">
            ...
            <tr>
                <td>Printed by : </td>
                <td><?php echo date_format($dt,"d/m/Y H:i:s") ?>&nbsp; <?php echo e($user); ?></td>
            </tr>
        </table>
    </div>
</body>
