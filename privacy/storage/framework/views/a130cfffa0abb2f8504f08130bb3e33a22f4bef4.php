        ...
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-produkor')) : ?>
                ...
                <?php if ($level != 'sany'){ ?>
                    ...
                    <a href="https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/produk/exportexcel?" target="_blank" id="printpembelian"><button type="button" class="btn bg-black btn-xs"><i class="fa fa-print"></i> CETAK LIST PRODUK</button></a>
            ...
            <?php echo Form::open(['id'=>'ADD']); ?>
                    ...
                    <div class="modal-body">
                        <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?php echo e(Form::label('kode_unit', 'Unit:')); ?>

                                        <?php echo e(Form::select('kode_unit',$Unit,null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Unit1'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('kode_merek', $Merek,null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Merek1'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <?php echo e(Form::label('max_qty', 'Max Stock:')); ?>

                                        <?php echo e(Form::text('max_qty', 0, ['class'=> 'form-control','id'=>'Max1', 'placeholder'=>'Max Stock','required'=>'required','autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"])); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('kode_unit',$Unit,null, ['class'=> 'form-control select2','style'=>'width: 100%','id'=>'Unit2'])); ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('kode_merek', $Merek,null, ['class'=> 'form-control select2','style'=>'width: 100%','id'=>'Merek2'])); ?>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('max_qty', 0, ['class'=> 'form-control','id'=>'Max', 'placeholder'=>'Max Stock','required'=>'required','autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"])); ?>
...
<div class="modal fade" id="showform" tabindex="-1" role="dialog">
    ...
    <div class="modal fade" id="button3"  role="dialog">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <?php if (app('laratrust')->can('update-produkor')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-produkor')) : ?>
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('produk.getkode'); ?>',
                        type:'POST',
        ...
        function getkode2(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                    $.ajax({
                        url:'<?php echo route('produk.getkode2'); ?>',
                        type:'POST',
                        success: function(result) {
                            swal("Berhasil!", result.message, "success");
                            refreshTable();
