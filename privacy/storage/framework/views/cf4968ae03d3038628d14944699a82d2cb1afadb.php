  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <br>
        <h4 class="modal-title" id="exampleModalLabel">Produk yang sudah mencapai maximum stok <span class="badge bg-blue pull-right"><?php echo e($i); ?></span></h4>
            <?php $__currentLoopData = $produk_max; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <?php 
              if($item->max_qty > $item->ending_stock) { ?>
                <td><b><?php echo e($item->nama_produk); ?></b> <p style="color:blue">(Max Stock : <?php echo e($item->max_qty); ?>) / <b>(End. Stock : <?php echo e($item->ending_stock); ?>)</b></p></td>
              <?php } ?>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
