...
<?php $__env->startSection('title', 'WO Detail'); ?>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.2.0/sweetalert2.min.css">
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail WO <b><?php echo e($work->no_wo); ?></b></font>
    </span>
    ...
    <div class="box box-danger">
        <div class="box-body"> 
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('No', 'No WO:')); ?>

                            <?php echo e(Form::text('no_wo',$work->no_wo, ['class'=> 'form-control','readonly','id'=>'NoWO1'])); ?>

                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('Tipes', 'Type:')); ?>

                            <?php echo e(Form::select('type', ['Stock'=>'Stock','NonStock'=>'NonStock','Lainnya'=>'Lainnya'],null, ['class'=> 'form-control select2','style'=>'width:100%','id'=>'Type1','placeholder'=>'','required','onchange'=>'ambil()'])); ?>

                        </div>
                    </div>
                    <!--<?php echo e(Form::hidden('type','Stock', ['class'=> 'form-control','readonly','id'=>'Type1'])); ?>-->
                    <div class="col-md-5">
                        <div class="form-group">
                            <?php echo e(Form::label('Kodes', 'Produk:')); ?>

                            <?php echo e(Form::select('kode_produk',$Produk->sort(),null,['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Produk1','onchange'=>'stock();','required'])); ?>

                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('partok', 'Part Number:')); ?>

                            <?php echo e(Form::select('partnumber',[], "-", ['class'=> 'form-control select2','id'=>'Parts','style'=>'width: 100%','autocomplete'=>'off','required'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Kodesss', 'Non Stock:')); ?>

                            <?php echo e(Form::text('nonstock',null,['class'=> 'form-control','id'=>'NonStock1'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Kodesss', 'Item Lain:')); ?>

                            <?php echo e(Form::text('item_lain',null,['class'=> 'form-control','id'=>'Lainnya1'])); ?>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('qty', null, ['class'=> 'form-control','required','id'=>'Qty1','autocomplete'=>'off','required'])); ?>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('qty_stock', null, ['class'=> 'form-control','readonly','id'=>'QtyStock1'])); ?>
            ...
            <div class="editform">
                ...
                <div class="row">   
                    <?php echo e(Form::hidden('id', null, ['class'=> 'form-control','readonly','id'=>'ID2'])); ?>

                    <div class="col-md-2">
                        <div class="form-group">
                            <?php echo e(Form::label('No', 'No WO:')); ?>

                            <?php echo e(Form::text('no_wo',$work->no_wo, ['class'=> 'form-control','readonly','id'=>'NoWO2'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('type',null, ['class'=> 'form-control','style'=>'width:100%','readonly','id'=>'Type2','placeholder'=>'','required'])); ?>

                        </div>
                    </div>
                    <!--<?php echo e(Form::hidden('type','Stock', ['class'=> 'form-control','readonly','id'=>'Type2'])); ?>-->
                    <div class="col-md-5">
                        <div class="form-group">
                            <?php echo e(Form::label('kode_produk', 'Produk:')); ?>

                            <?php echo e(Form::select('kode_produk',$Produk->sort(),null,['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Produk2','onchange'=>'stock2()'])); ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('partnumber',[], null, ['class'=> 'form-control select2','id'=>'Parts2','required','style'=>'width: 100%','autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nonstock',null,['class'=> 'form-control','id'=>'NonStock2'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('item_lain',null,['class'=> 'form-control','id'=>'Lainnya2'])); ?>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('qty', null, ['class'=> 'form-control','required','id'=>'Qty2','autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('qty_stock', null, ['class'=> 'form-control','readonly','id'=>'QtyStock2'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        function editpart(){
            ...
            $.ajax({
                url: "<?php echo route('workorderdetail.selectpart'); ?>",
                method: 'POST',
        ...
        function stock(){
            ...
            $.ajax({
                url:'<?php echo route('workorderdetail.stockproduk'); ?>',
                type:'POST',
                data : {
                        'id': kode_produk,
                    },
        ...
        $('#ADD_DETAIL').submit(function (e) {
            ...
            // Check if empty of not
            $.ajax({
                url:'<?php echo route('workorderdetail.store'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    console.log(data);
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            var formData = registerForm.serialize();
            $.ajax({
                url:'<?php echo route('workorderdetail.updateajax'); ?>',
                type:'POST',
                data:formData,
                success:function(data) {
                    $('#Qty1').val('');
