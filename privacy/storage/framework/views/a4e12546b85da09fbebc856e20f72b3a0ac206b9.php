                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('id_lokasi', 'ID Lokasi:')); ?>

                                    <?php echo e(Form::text('id_lokasi', null, ['class'=> 'form-control','id'=>'id1', 'placeholder'=>'ID Lokasi','required'=>'required','autocomplete'=>'off'])); ?>
