            ...
            <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('users.store')); ?>">
                        <?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <?php echo e(Form::select('roles[]', $Roles, null, ['class'=> 'form-control select2','required'=>'required','style'=>'width: 100%','placeholder' => ''])); ?>
                            ...
                            <div class="form-group<?php echo e($errors->has('kode_company') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php echo e(Form::select('kode_company', $Company, null, ['class'=> 'form-control select2','required'=>'required','style'=>'width: 100%','placeholder' => ''])); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <?php echo e(Form::select('kode_lokasi', $Lokasi, null, ['class'=> 'form-control select2','required'=>'required','style'=>'width: 100%','placeholder' => ''])); ?>
