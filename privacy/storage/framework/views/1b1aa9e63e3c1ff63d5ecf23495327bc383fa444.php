...
<?php echo e(Form::hidden('n10', null, ['class'=> 'form-control','id'=>'Grandios1','readonly'])); ?>
                ...
                <div class="row" style="font-size: 8pt;">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            Tipe : <?php echo e(Form::label('nomoor', null,['id'=>'PreviewTipe'])); ?><br>
                            Nama : <?php echo e(Form::label('nomoor', null,['id'=>'PreviewAlat'])); ?><br>
                            No. Asset : <?php echo e(Form::label('nomoor', null,['id'=>'PreviewAsset'])); ?><br>
                            No. JO : <?php echo e(Form::label('nomoor', null,['id'=>'PreviewJo'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            No. PK : <?php echo e(Form::label('nomoor', null,['id'=>'PreviewNomor'])); ?><br>
                            Tgl. PK : <?php echo e(Form::label('nomoor', null,['id'=>'PreviewTanggal'])); ?><br>
                            Pemakai : <?php echo e(Form::label('nomoor', null,['id'=>'PreviewPemakai'])); ?><br>
                            No. WO : <?php echo e(Form::label('nomoor', null,['id'=>'PreviewWo'])); ?>
            ...
            <div class="container-fluid table-responsive">
                ...
                <div class="modal-footer">
                    <span class="pull-left">
                        Note : <?php echo e(Form::label('nomoor', null,['id'=>'PreviewNote'])); ?>
...
<div class="modal fade" id="calcform"  role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo Form::open(['id'=>'CALC_JURNAL']); ?>

            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <?php echo e(Form::label('jenis', 'Bulan:')); ?> 
            ...
            <div class="modal-footer">
                <div class="row">
                    <?php echo e(Form::submit('Calculate', ['class'=>'btn btn-success crud-submit' , 'id'=>'create-button'])); ?>
                            ...
                            <?php if (auth()->user()->kode_company == '02') { ?>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('type', ['Mobil'=>'Mobil','Alat'=>'Alat','Kapal'=>'Kapal','Other'=>'Other','Mekanik'=>'Mekanik PBM','Foreman'=>'Foreman PBM','Operasional'=>'Operasional PBM'],null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'type','onchange'=>"pakai();",'required'])); ?>
                            ...
                            <?php } ?>
                                ...
                                <?php if (Auth()->user()->kode_company == '02') { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <br>
                                            <?php echo e(Form::label('Nomoo', 'No WO:')); ?>

                                            <?php echo e(Form::select('no_wo', $Workorder->sort(),null, ['class'=> 'form-control select2','id'=>'Wo1','placeholder'=>'','','style'=>'width: 100%', 'onchange'=>'getwoalat();'])); ?>
                                    ...
                                    <!--        <br>-->
                                    <!--        <?php echo e(Form::label('Nomoo', 'No WO:')); ?>-->
                                    <!--        <?php echo e(Form::text('no_wo',null, ['class'=> 'form-control','id'=>'Wo1','placeholder'=>'','','style'=>'width: 100%'])); ?>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                <?php } ?>
                                ...
                                <?php if (Auth()->user()->kode_company == '03') { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <br>
                                            <?php echo e(Form::label('cosot', 'Cost Center:')); ?>

                                            <?php echo e(Form::select('cost_center',$Costcenter,null, ['class'=>'form-control select2','id'=>'Cost1','style'=>'width: 100%','placeholder'=>''])); ?>
                            ...
                            <?php if (auth()->user()->kode_company == '05') { ?>
                                <div class="col-md-4">
                                    <div class="form-group23">
                                        ...
                                        <?php echo e(Form::select('no_jo', $Joborder->sort(), null, ['class'=> 'form-control select2','id'=>'Jo1','style'=>'width: 100%','placeholder' => ''])); ?>
                            ...
                            <?php } else { ?>
                                <div class="col-md-4">
                                    <div class="form-group23">
                                        ...
                                        <?php echo e(Form::text('no_jo', 0, ['class'=> 'form-control','id'=>'Jo1','onkeypress'=>"return pulsar(event,this)"])); ?>
                            ...
                            <?php } ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group20">
                                        <br>
                                        <?php echo e(Form::label('hmkm', 'HM:')); ?>

                                        <?php echo e(Form::text('hmkm', null, ['class'=> 'form-control','id'=>'hmkm1', 'placeholder'=>'HourMeter', 'autocomplete'=>'off'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group20">
                                        <br>
                                        <?php echo e(Form::label('kkkk', 'KM:')); ?>

                                        <?php echo e(Form::text('km', null, ['class'=> 'form-control','id'=>'km1', 'placeholder'=>'KiloMeter', 'autocomplete'=>'off'])); ?>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <?php echo Form::open(['id'=>'EDIT']); ?>
                            ...
                            <div class="modal-body">
                                <?php echo e(Form::hidden('company_user', auth()->user()->kode_company, ['class'=> 'form-control','id'=>'company2','readonly'])); ?>
                                ...
                                <div class="row">                                
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('type', ['Mobil'=>'Mobil','Alat'=>'Alat','Kapal'=>'Kapal','Other'=>'Other','Mekanik'=>'Mekanik PBM','Foreman'=>'Foreman PBM','Operasional'=>'Operasional PBM'],null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'typeedit','onchange'=>"pakai2();",'required'])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('type', ['Mobil'=>'Mobil','Alat'=>'Alat','Kapal'=>'Kapal','Other'=>'Other'],null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'typeedit','onchange'=>"pakai2();",'required'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group2">
                                            <div id="nopols1">
                                                ...
                                                <?php echo e(Form::select('kode_mobil',$Mobil,null, ['class'=>'form-control select2','id'=>'Nopol','style'=>'width: 100%','onchange'=>'getasetmobil2();'])); ?>
                                            ...
                                            <div id="alats1">
                                                ...
                                                <?php echo e(Form::select('kode_alat',$Alat,null, ['class'=>'form-control select2','id'=>'Alat','style'=>'width: 100%','onchange'=>'getasetalat2();'])); ?>                                      
                                            </div>

                                            <div id="kapals1">
                                                <?php echo e(Form::label('kode_kapal', 'Nama Kapal:')); ?>

                                                <?php echo e(Form::select('kode_kapal',$Kapal,null, ['class'=>'form-control select2','id'=>'Kapal','style'=>'width: 100%','onchange'=>'getasetkapal2();'])); ?>                                      
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group11">
                                            <div id="asetnopols1">
                                                ...
                                                <?php echo e(Form::select('no_asset_mobil',$Asmobil,null, ['class'=>'form-control select2','id'=>'Asetmobil','style'=>'width: 100%'])); ?>
                                            ...
                                            <div id="asetalats1">
                                                ...
                                                <?php echo e(Form::select('no_asset_alat',$Asalat,null, ['class'=>'form-control select2','id'=>'Asetalat','style'=>'width: 100%'])); ?>
                                            ...
                                            <div id="asetkapals1">
                                                ...
                                                <?php echo e(Form::select('no_asset_kapal',$Askapal,null, ['class'=>'form-control select2','id'=>'Asetkapal','style'=>'width: 100%'])); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group22">
                                            ...
                                            <?php echo e(Form::text('no_jo', null, ['class'=> 'form-control','id'=>'Jo','onkeypress'=>"return pulsar(event,this)"])); ?>
                                ...
                                <?php if (Auth()->user()->kode_company == '02') { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('no_wo', $Workorder->sort(),null, ['class'=> 'form-control select2','id'=>'Wo2','placeholder'=>'','','style'=>'width: 100%'])); ?>
                                    ...
                                    <!--        <br>-->
                                    <!--        <?php echo e(Form::label('Nomoo', 'No WO:')); ?>-->
                                    <!--        <?php echo e(Form::text('no_wo', null, ['class'=> 'form-control','id'=>'Wo2','placeholder'=>'','','style'=>'width: 100%'])); ?>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                <?php } ?>
                                ...
                                <?php if (Auth()->user()->kode_company == '03') { ?>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('cost_center',$Costcenter,null, ['class'=>'form-control select2','id'=>'Cost2','style'=>'width: 100%','placeholder'=>''])); ?>
                                ...
                                <?php } ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <?php echo e(Form::text('hmkm', null, ['class'=> 'form-control','id'=>'hmkm2', 'placeholder'=>'HourMeter', 'autocomplete'=>'off'])); ?>
                                    ...
                                    <div class="col-md-4">
                                        <br>
                                        <div class="form-group21">
                                        <?php echo e(Form::label('hhhh', 'KM:')); ?>

                                        <?php echo e(Form::text('km', null, ['class'=> 'form-control','id'=>'km2', 'placeholder'=>'KiloMeter', 'autocomplete'=>'off'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        function hitungjurnal(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('pemakaian.hitungjurnal'); ?>',
                        type:'POST',
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                    $.ajax({
                        url:'<?php echo route('pemakaian.getkode'); ?>',
                        type:'POST',
                        success: function(result) {
                            swal("Berhasil!", result.message, "success");
                            refreshTable();
        ...
        function tablepreview(kode){
            $.ajax({
                url: '<?php echo route('pemakaian.getDatapreview'); ?>',
                type: 'GET',
                data : {
                    'id': kode
                },
        ...
        function limiter() {
            $.ajax({
                        url: '<?php echo route('pemakaian.limitos'); ?>',
                        type: 'GET',
                        data : {
                        },
 ...
 //FUNGSI BREAKDOWN
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    $.ajax({
                        url: '<?php echo route('pemakaian.previewpo'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_pemakaian
                        },
                    ...
                    $.ajax({
                        url: '<?php echo route('pemakaian.historia'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_pemakaian
                        },
                    ...
                    $.ajax({
                        url: '<?php echo route('pemakaian.grandios'); ?>',
                        type: 'GET',
                        data : {
            ...
            $('#button4').click( function () {
                ...
                swal({
                    ...
                    // alert( table.rows('.selected').data().length +' row(s) selected' );
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('pemakaian.postingulang'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pemakaian
                            },
            ...
            $('#detailjurnal2').click( function () {
                ...
                var no_journal = data['no_journal'];
                $.ajax({
                    url: '<?php echo route('pemakaian.getDatajurnal2'); ?>',
                    type: 'GET',
                    data : {
                        'id': no_journal,
                    },
            ...
            function cekjurnal2(){
                ...
                $.ajax({
                    url:'<?php echo route('pemakaian.cekjurnal2'); ?>',
                    type:'POST',
                    data : {
            ...
            $(document).on('click', '#btn-save', function() {
                ...
                var no_pemakaian = data['no_pemakaian'];
                $.ajax({
                    url: '<?php echo route('pemakaian.ttd_buat'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_pemakaian,
                        'img': img,
            ...
            $(document).on('click', '#btn-terima', function() {
                ...
                var no_pemakaian = data['no_pemakaian'];
                $.ajax({
                    url: '<?php echo route('pemakaian.ttd_terima'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_pemakaian,
                        'img': img,
        ...
        function getwoalat(){
            var work_order = $('#Wo1').val();
             $.ajax({
                url:'<?php echo route('pemakaian.getwoalat'); ?>',
                type:'POST',
                data : {
                        'no_wo': work_order,
                    },
        ...
        function getkodealat2(){
            ...
            $.ajax({
                url:'<?php echo route('pemakaian.getkodealat2'); ?>',
                type:'POST',
                data : {
                        'id': asetalat,
                    },
        ...
        function getkodemobil2(){
            ...
            $.ajax({
                url:'<?php echo route('pemakaian.getkodemobil2'); ?>',
                type:'POST',
                data : {
                        'id': asetmobil,
                    },
        ...
        function getkodekapal2(){
            ...
            $.ajax({
                url:'<?php echo route('pemakaian.getkodekapal2'); ?>',
                type:'POST',
                data : {
                        'id': asetkapal,
                    },
        ...
        $('#CALC_JURNAL').submit(function (e) {
            ...
            $.ajax({
                url:'<?php echo route('pemakaian.kalkulasi_jurnal'); ?>',
                type:'POST',
                data:formData,
