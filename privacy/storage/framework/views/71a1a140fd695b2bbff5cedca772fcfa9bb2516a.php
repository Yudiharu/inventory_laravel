...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-konversi')) : ?>
...
<div class="modal fade" id="editform" role="dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                            <div class="row">
                                ...
                                <?php echo e(Form::hidden('kode_produk',null, ['class'=> 'form-control','id'=>'Produk2','readonly'])); ?>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nama_produk',null, ['class'=> 'form-control','id'=>'NamaProduk2','readonly'])); ?>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('kode_satuan',$Satuan,null, ['class'=> 'form-control select2','style'=>'width: 100%','id'=>'Kode_Terbesar2','onchange'=>'satuan3()','required'=>'required'])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-konversi')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-konversi')) : ?>
    ...
    <script type="text/javascript">
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('konversi.getkode'); ?>',
                        type:'POST',
        ...
        $(document).ready(function() {
            ...
            $('#editkonversi').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('konversi.edit_konversi'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_konversi
                    },
            ...
            $('#hapuskonversi').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('konversi.hapus_konversi'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_konversi
                            },
