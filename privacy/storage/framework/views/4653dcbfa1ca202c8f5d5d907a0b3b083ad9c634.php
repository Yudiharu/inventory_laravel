...
<div class="fixed-header">
	...
	<table class="table_content" style="margin-bottom: 25px;width: 100%;">
        ...
        <tr class="border" style="background-color: #e6f2ff">
            ...
            <th class="border" width="">Tipe Pemakaian</th>
            <th class="border" width="">Pemakai</th>
            <th class="border" width="">Keterangan</th>
            <th class="border" width="">Alasan Pakai</th>
        <?php if ($tipe == 'Alat') { ?>
            <th class="border" width="">Nama Alat</th>
            <th class="border" width="">No Asset Alat</th>
        <?php }else if ($tipe == 'Mobil') { ?>
            <th class="border" width="">No Asset Mobil</th>
        <?php }else if ($tipe == 'Kapal') { ?>
            <th class="border" width="">Nama Kapal</th>
            <th class="border" width="">No Asset Kapal</th>
        <?php }else if ($tipe == 'SEMUA') { ?>
        ...
        <?php } ?>
        <?php if ($kategoriproduk == 'true' || $semua == 'true') { ?>
            <th class="border" width="">Kode Kategori</th>
        <?php } ?>
            <th class="border" width="">Qty</th>
            <!--<th class="border" width="">Qty Retur</th>-->
        ...
        <?php if ($row->qty_retur != $row->qty) { ?>
            <tr class="border">
                ...
                <td class="border" align="left"><?php echo $row->deskripsi?></td>
                <?php
            ...
            <?php } ?>
                <!--<td class="border" align="center"><?php echo $row->qty_retur?></td>-->
            <?php endif; // app('laratrust')->can ?>
