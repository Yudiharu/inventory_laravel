...
<body onLoad="load()">
    <div class="box box-solid">
        <div class="box-body">
            <div class="box ">
                <div class="box-body">
                    <?php if (app('laratrust')->can('create-vendoror')) : ?>
    ...
    <div class="modal fade" id="editform" role="dialog">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <?php echo e(Form::select('type', ['Vendor' => '1', 'Sopir' => '2'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'type','required'=>'required','onchange'=>"getcoa2();"])); ?>
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <?php if (app('laratrust')->can('update-vendoror')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-vendoror')) : ?>
    ...
    function hanyaAngka(e, decimal) {
        ...
        $(document).ready(function(){
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('vendor.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_vendor
                    },
