<?php $__env->startSection('title', 'Laporan Pemakaian Ban'); ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title">Laporan <b>Pemakaian Ban</b></h4>
                </div>
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                <?php echo Form::open(['route' => ['laporanpemakaianban.export'],'method' => 'get','id'=>'form', 'target'=>"_blank"]); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group"> 
                                            ...
                                            <?php echo e(Form::select('tipe', ['SEMUA' => 'SEMUA', 'Alat' => 'Alat', 'Mobil' => 'Mobil'], null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'tipe1','required'=>'required', 'onchange'=>"cektipe()"])); ?>
    ...
    <script type="text/javascript">
        ...
        function cetakpdf() {
            ...
            if (e.value === true) {
                ...
                $.ajax({
                    url:'<?php echo route('laporanpemakaianban.export'); ?>',
                    type:'GET',
                    data:formData,
