...
<head>
    ...
    <br>
    <title>Laporan Pemakaian Ban ~ <?php echo e($no_pemakaianban); ?></title>
    <style>
        @page  {
...
<div class="header">
    <div class="left">
        <table width="50%" style="font-size: 10pt" border="0">
            <tr>
                <td style="width: 180px">Nama Alat</td>
                <td style="width: 10px">:</td>
                <td><?php echo e($nama_alat->nama_alat); ?></td>
            </tr>
            <tr>
                <td>No Aset Alat</td>
                <td>:</td>
                <td><?php echo e($nama_alat->no_asset_alat); ?></td>
            </tr>
        </table>
    </div>
    <div class="right">
        <table width="50%" style="padding-left:8em; font-size: 10pt" border="0">
            <tr>
                <td style="width: 180px">No. Pemakaian Ban</td>
                <td style="width: 10px">:</td>
                <td><?php echo e($no_pemakaianban); ?></td>
            </tr>
            <tr>
    ...
    <section class="list-item">
        <table style="font-size: 10pt; width: 19cm;" border="0" >
            ...
            <tr >
                ...
                <th colspan="2" width="">Total</th>
            </tr>
            </thead>
            <tbody>
            <?php $subtotal = 0 ; $limit_row = 0?>
            <?php foreach ($pemakaianbandetail as $key => $value): ?>
                <tr >
                    <td ><?php echo $key+1 ?></td>
                    <td ><?php echo $value->produk->nama_produk ?></td>
                    <td ><?php echo $value->partnumberbaru ?></td>
                    <td >
                        <?php
            ...
            $total_row = count($pemakaianbandetail);
            $max_row = (9 - $limit_row) ;
