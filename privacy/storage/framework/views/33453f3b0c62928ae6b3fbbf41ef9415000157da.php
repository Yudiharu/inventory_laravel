<?php $__env->startSection('title', 'Disassembling'); ?>
        ...
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-disassembling')) : ?>
            ...
            <?php echo Form::open(['id'=>'ADD']); ?>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('qty_disassembling', 'Qty Disassembling:')); ?>

                                    <?php echo e(Form::text('qty_disassembling', null, ['class'=>'form-control','required'=>'required','id'=>'QTY','onkeyup'=>'check();','autocomplete'=>'off'])); ?>
...
<div class="modal fade" id="editform" role="dialog">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('qty_disassembling', null, ['class'=>'form-control','required'=>'required','id'=>'QTY1','onkeyup'=>'cek_qty2();','autocomplete'=>'off'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::number('hpp',null, ['class'=> 'form-control','id'=>'Harga1','readonly'])); ?>
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-disassembling')) : ?>
            ...
            <?php if (app('laratrust')->can('add-disassembling')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-disassembling')) : ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $(function() {
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('disassembling.data'); ?>',
        ...
        function editpart(){
            ...
            $.ajax({
                url: "<?php echo route('disassembling.selectpart'); ?>",
                method: 'POST',
        ...
        function getharga(){
            ...
            $.ajax({
                url:'<?php echo route('disassembling.getharga'); ?>',
                type:'POST',
                data : {
                        'id': kode_produk,
                        'part': partnumber,
        ...
        function cek_qty2(){
            ...
            var qty = $('#QTY1').val();
             ...
             $.ajax({
                url:'<?php echo route('disassembling.qtyproduk2'); ?>',
                type:'POST',
                data : {
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#adddisassembling").attr("href","http://localhost/gui_inventory_laravel/admin/disassembling/"+id+"/detail");
                    var print2 = $("#printzoom3").attr("href","http://localhost/gui_inventory_laravel/admin/disassembling/exportpdf3?no_journal="+no_journal + "&id="+id);
           ...
           $('#button1').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        $.ajax({
                            url: '<?php echo route('disassembling.posting'); ?>',
                            type: 'POST',
                            data : {
                                'id': id
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('disassembling.unposting'); ?>',
                            type: 'POST',
                            data : {
                                'id': id
                            },
            ...
            $('#detailjurnal2').click( function () {
                ...
                var no_journal = select.find('td:eq(8)').text();
                $.ajax({
                    url: '<?php echo route('disassembling.getDatajurnal2'); ?>',
                    type: 'GET',
                    data : {
                        'id': no_journal,
                    },
            ...
            function cekjurnal2(){
                ...
                $.ajax({
                    url:'<?php echo route('disassembling.cekjurnal2'); ?>',
                    type:'POST',
                    data : {
            ...
            $('#button3').click( function () {
                ...
                var id = data['id'];
                $.ajax({
                    url: '<?php echo route('disassembling.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': id
                    },
            ...
            $('#editdisassembling').click( function () {
                ...
                var id = data['id'];
                $.ajax({
                    url: '<?php echo route('disassembling.edit_disassembling'); ?>',
                    type: 'POST',
                    data : {
                        'id': id
                    },
            ...
            $('#hapusdisassembling').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('disassembling.hapus_disassembling'); ?>',
                            type: 'POST',
                            data : {
                                'id': id
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('disassembling.store'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('disassembling.updateAjax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
