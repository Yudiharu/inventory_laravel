...
<?php $__env->startSection('title', 'Assembling'); ?>
        ...
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-assembling')) : ?>
                    <button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#addform"><i class="fa fa-plus"></i> New Assembling</button>
                    <?php endif; // app('laratrust')->can ?>

                    <span class="pull-right">  
                        <font style="font-size: 16px;"><b>ASSEMBLING</b></font>
                    </span>
            ...
            <?php echo Form::open(['id'=>'ADD']); ?>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php echo e(Form::label('kode_produk', 'Produk Jadi:')); ?>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="hidden" name="update_stok" value="N" />
                                    <input type="checkbox" name="update_stok" id="stok1" value="Y"/>&nbsp;<b>Update Stock?</b>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('qty_assembling', 'Qty Assembling:')); ?>

                                    <?php echo e(Form::text('qty_assembling', 1, ['class'=>'form-control','required'=>'required','id'=>'QTY','readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('hpp',null, ['class'=> 'form-control','id'=>'Harga','required'])); ?>

                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <?php echo e(Form::label('jas', 'Jasa:')); ?>

                                    <?php echo e(Form::text('nama_jasa', null, ['class'=>'form-control','id'=>'Jasa1','placeholder'=>'Nama Jasa'])); ?>

                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('jas', 'Biaya Jasa:')); ?>

                                    <?php echo e(Form::text('biaya_jasa', 0, ['class'=>'form-control','id'=>'Biaya1'])); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::textArea('keterangan', null, ['class'=> 'form-control','rows'=>'4','id'=>'Keterangan', 'placeholder'=>'Keterangan','required'=>'required', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            <?php echo e(Form::submit('Create data', ['class' => 'btn btn-success crud-submit', 'id'=>'submit'])); ?>
...
<div class="modal fade" id="editform" role="dialog">
              ...
              <div class="modal-content">
                ...
                <?php echo $__env->make('errors.validation', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    <?php echo Form::open(['id'=>'EDIT']); ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <?php echo e(Form::hidden('no_ass', null, ['class'=> 'form-control','id'=>'id1'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('tanggal', null,['class'=> 'form-control','id'=>'Tanggal1'])); ?>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="hidden" name="update_stok" value="N" />
                                        <input type="checkbox" name="update_stok" id="stok2" value="Y"/>&nbsp;<b>Update Stock?</b>
                                        <?php echo e(Form::select('kode_produk',$Produk->sort(),null,
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('partnumber', null, ['class'=> 'form-control','id'=>'Parts1','style'=>'width: 100%','readonly','onchange'=>'getharga2();'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('qty_stock', null, ['class'=> 'form-control','readonly','id'=>'Stock1'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('qty_assembling', null, ['class'=>'form-control','required'=>'required','id'=>'QTY1','autocomplete'=>'off'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('hpp',null, ['class'=> 'form-control','id'=>'Harga1','required'])); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nama_jasa', null, ['class'=>'form-control','id'=>'Jasa2','placeholder'=>'Nama Jasa'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('biaya_jasa', null, ['class'=>'form-control','id'=>'Biaya2'])); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::textArea('keterangan', null, ['class'=> 'form-control','rows'=>'4','id'=>'Keterangan1', 'placeholder'=>'Keterangan','required'=>'required', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                        ...
                        <div class="modal-footer">
                            <div class="row">
                                <?php echo e(Form::submit('Update data', ['class' => 'btn btn-success crud-submit', 'id'=>'submit2'])); ?>
    ...
    <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i><?php echo e($nama_company); ?></i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-assembling')) : ?>
            <button type="button" class="btn btn-warning btn-xs edit-button" id="editassembling" data-toggle="modal" data-target="">EDIT <i class="fa fa-edit"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('add-assembling')) : ?>
            <a href="#" id="addassembling"><button type="button" class="btn btn-info btn-xs add-button" data-toggle="modal" data-target="">ADD <i class="fa fa-plus"></i></button></a>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('delete-assembling')) : ?>
            <button type="button" class="btn btn-danger btn-xs hapus-button" id="hapusassembling" data-toggle="modal" data-target="">HAPUS <i class="fa fa-times-circle"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('post-assembling')) : ?>
            <button type="button" class="btn btn-success btn-xs tombol1" id="button1">POST <i class="fa fa-bullhorn"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('unpost-assembling')) : ?>
            <button type="button" class="btn btn-warning btn-xs tombol2" id="button2">UNPOST <i class="fa fa-undo"></i></button>
            <?php endif; // app('laratrust')->can ?>

            <?php if (app('laratrust')->can('view-assembling')) : ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        $(function() {
            ...
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('assembling.data'); ?>',
            ...
            columns: [
                ...
                { data: 'qty_assembling', name: 'qty_assembling' },
                { data: 'keterangan', name: 'keterangan' },
                { data: 'total_item', name: 'total_item' },
                { data: 'update_stok', name: 'update_stok' },
                { data: 'status', 
                    render: function( data, type, full ) {
        ...
        function editpart(){
            ...
            $.ajax({
                url: "<?php echo route('assembling.selectpart'); ?>",
                method: 'POST',
        ...
        function getharga(){
            ...
            $.ajax({
                url:'<?php echo route('assembling.getharga'); ?>',
                type:'POST',
                data : {
                        'id': kode_produk,
                        'part': partnumber,
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addassembling").attr("href",window.location.href+"/"+id+"/detail");
           ...
           $('#button1').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        $.ajax({
                            url: '<?php echo route('assembling.posting'); ?>',
                            type: 'POST',
                            data : {
                                'id': id
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('assembling.unposting'); ?>',
                            type: 'POST',
                            data : {
                                'id': id
                            },
            ...
            $('#detailjurnal2').click( function () {
                ...
                var no_journal = data['no_journal'];
                $.ajax({
                    url: '<?php echo route('assembling.getDatajurnal2'); ?>',
                    type: 'GET',
                    data : {
                        'id': no_journal,
                    },
            ...
            function cekjurnal2(){
                ...
                $.ajax({
                    url:'<?php echo route('assembling.cekjurnal2'); ?>',
                    type:'POST',
                    data : {
            ...
            $('#button3').click( function () {
                ...
                var id = data['no_ass'];
                $.ajax({
                    url: '<?php echo route('assembling.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': id
                    },
            ...
            $('#editassembling').click( function () {
                var select = $('.selected').closest('tr');
                var data = $('#data-table').DataTable().row(select).data();
                var id = data['no_ass'];
                $.ajax({
                    url: '<?php echo route('assembling.edit_assembling'); ?>',
                    type: 'POST',
                    data : {
                        'id': id
                    },
                    success: function(results) {
                        ...
                        $('#QTY1').val(results.qty_assembling);
                        $('#Jasa2').val(results.nama_jasa);
                        $('#Biaya2').val(results.biaya_jasa);
                        $('#Keterangan1').val(results.keterangan);
                        if (results.update_stok == 'Y') {
                            document.getElementById("stok2").checked = true;
                        }else {
                            document.getElementById("stok2").checked = false;
                        }
                    }
                });
            });

            $('#hapusassembling').click( function () {
                var select = $('.selected').closest('tr');
                var data = $('#data-table').DataTable().row(select).data();
                var id = data['no_ass'];
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('assembling.hapus_assembling'); ?>',
                            type: 'POST',
                            data : {
                                'id': id
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('assembling.store'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#Tanggal').val('');
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('assembling.updateAjax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#editform').modal('hide');
