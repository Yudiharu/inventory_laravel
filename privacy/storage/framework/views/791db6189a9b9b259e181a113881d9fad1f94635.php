                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_merek', null, ['class'=> 'form-control','id'=>'Kode1'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_merek', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required'])); ?>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('kode ukuran', 'Kode Merek:')); ?>

                            <?php echo e(Form::text('kode_merek', null, ['class'=> 'form-control','id'=>'Kode'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('nama_merek', null, ['class'=> 'form-control','id'=>'Nama'])); ?>
