                        ...
                        <div class="row">   
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('landedcost',0, ['class'=> 'form-control','required','readonly',
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        ...
        function editharga2(){
            ...
            $.ajax({
                url:'<?php echo route('penerimaandetail.getlanded'); ?>',
                type:'POST',
                data : {
                        'id': no_pembelian
                    },
        ...
        function getharga(){
            ...
            $.ajax({
                url:'<?php echo route('penerimaandetail.getharga'); ?>',
                type:'POST',
                data : {
                        'id': no_penerimaan
                    },
