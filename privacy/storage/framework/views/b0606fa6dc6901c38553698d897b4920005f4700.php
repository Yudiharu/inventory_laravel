                        ...
                        <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('nama_produk', null, ['class'=> 'form-control','id'=>'Nama1','required'=>'required', 'placeholder'=>'Nama Produk'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('partnumber', null, ['class'=> 'form-control','id'=>'Part1', 'placeholder'=>'Part Number'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('harga_beli', null, ['class'=> 'form-control','id'=>'Beli1', 'placeholder'=>'Harga Beli'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('harga_jual', null, ['class'=> 'form-control','id'=>'Jual1', 'placeholder'=>'Harga Jual'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('hpp', 0, ['class'=> 'form-control','id'=>'HPP1', 'placeholder'=>'HPP'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('stok', 0, ['class'=> 'form-control','id'=>'Stok1', 'placeholder'=>'Stock'])); ?>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_produk', null, ['class'=> 'form-control','id'=>'Nama2','autofocus'=>'autofocus'])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_kategori',$Kategori,null, ['class'=> 'form-control','id'=>'Kategori2'])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_merek', $Merek,null, ['class'=> 'form-control','id'=>'Merek2'])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::select('kode_satuan', $Satuan,null, ['class'=> 'form-control','id'=>'Satuan2'])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('harga_beli', null, ['class'=> 'form-control','id'=>'Beli2'])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('harga_jual', null, ['class'=> 'form-control','id'=>'Jual2'])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('hpp', null, ['class'=> 'form-control','id'=>'HPP2'])); ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('stok', null, ['class'=> 'form-control','id'=>'Stok2'])); ?>
            ...
            <div class="modal-body">
                    <div class="row">
                        ...
                        <span class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <?php echo e(Form::label('status', 'Aktif:')); ?>

                                    <?php echo e(Form::text('status', null, ['class'=> 'form-control','id'=>'Aktif3'])); ?>
...
<div class="modal fade" id="showform" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h5 class="modal-title">Show Detail Data</h5>
            </div>
...
<script type="text/javascript">
        ...
        $('#EDIT').submit(function (e) {
            ...
            // Check if empty of not
            if (kode === '' || name === ''|| kategori === ''|| beli === ''|| jual === ''|| hpp === ''|| stok === ''|| status === '') {
                alert('Mohon Lengkapi Form Isian');
                return false;
            }else{
                $.ajax({
        ...
        $('#KONVERSI').submit(function (e) {
            ...
            var status = $.trim($('#Aktif3').val());
            var registerForm = $("#KONVERSI");
            var formData = registerForm.serialize();

            // Check if empty of not
            if (kode === '' || name === ''|| kategori === ''|| merek === ''|| satuan === ''|| beli === ''|| jual === ''|| hpp === ''|| stok === ''|| status === '') {
                alert('Mohon Lengkapi Form Isian');
                return false;
            }else{
                $.ajax({
