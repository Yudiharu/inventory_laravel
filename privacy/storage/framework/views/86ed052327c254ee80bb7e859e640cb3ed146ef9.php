...
<body onLoad="load()">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('nama_alat', null, ['class'=> 'form-control','id'=>'Nama1', 'placeholder'=>'Nama Alat','required'=>'required', 'autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('type', null, ['class'=> 'form-control','id'=>'Nama3','required'=>'required', 'placeholder'=>'Type', 'autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('no_asset_alat', null, ['class'=> 'form-control','id'=>'Asset1', 'placeholder'=>'No. Asset', 'autocomplete'=>'off','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 15 Karakter", 'maxlength'=>'15','required'=>'required', 'style'=>"text-transform: uppercase;"])); ?>
    ...
    <div class="modal fade" id="editform" tabindex="-1" role="dialog">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('type', null, ['class'=> 'form-control','id'=>'Type','required'=>'required', 'autocomplete'=>'off', 'style'=>"text-transform: uppercase;"])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('no_asset_alat', null, ['class'=> 'form-control','id'=>'Asset', 'autocomplete'=>'off','readonly','data-toggle'=>"tooltip",'data-placement'=>"bottom",'title'=>"Maksimal 15 Karakter", 'maxlength'=>'15', 'style'=>"text-transform: uppercase;"])); ?>
      ...
      <button type="button" class="back2Top btn btn-warning btn-xs" id="back2Top"><i class="fa fa-arrow-up" style="color: #fff"></i> <i>{{$nama_company}}</i> <b>(<?php echo e($nama_lokasi); ?>)</b></button>
