                    ...
                    <center><kbd>ADD FORM</kbd></center><br>
                        ...
                        <?php echo e(Form::hidden('Link',request()->getSchemeAndHttpHost(), ['class'=> 'form-control','readonly','id'=>'Link1'])); ?>
                            ...
                            <div class="col-md-2">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?php echo e(Form::label('Deskripsi', 'Alasan Pakai:')); ?>

                                        <?php echo e(Form::textArea('keterangan', null, ['class'=> 'form-control','rows'=>'2','id'=>'Deskripsi1', 'placeholder'=>'Keterangan', 'autocomplete'=>'off','required'])); ?>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::textArea('keterangan', null, ['class'=> 'form-control','rows'=>'2','id'=>'Deskripsi2', 'placeholder'=>'Keterangan', 'autocomplete'=>'off','required'])); ?>
...
<?php $__env->startPush('js'); ?>
  ...
  <script>
        ...
        function gethpp(){
            ...
            $.ajax({
                url:'<?php echo route('pemakaiandetail.gethpp'); ?>',
                type:'POST',
                data : {
                        'id': no_pemakaian
                    },
        ...
        function hapusall(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    var no_pemakaian = $('#nopakai').val();
                    $.ajax({
                        url:'<?php echo route('pemakaiandetail.hapusall'); ?>',
                        type:'POST',
                        data : {
                            'id': no_pemakaian
                        },
