...
<?php $__env->startSection('title', 'Work Order'); ?>
        ...
        <div class="box-body">
            <div class="box">
                <div class="box-body">
                    ...
                    <?php if (app('laratrust')->can('create-workorder')) : ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('No Alat', 'No Reff:')); ?>

                            <?php echo e(Form::text('no_reff', null, ['class'=> 'form-control','id'=>'NoReff1','autocomplete'=>'off'])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggal', 'Date In :')); ?>

                            <!--<input type='datetime-local' class='form-control' id='DateIn1' name='date_in' value='<?php echo e(\Carbon\Carbon::now()); ?>' required/>-->
                            <?php echo e(Form::datetimelocal('date_in', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'DateIn1' ,'required','onchange'=>"hitungdate()"])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('Tanggal', 'Date Finish :')); ?>

                            <?php echo e(Form::datetimelocal('date_finish', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'DateFinish1' ,'required','onchange'=>"hitungdate()"])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('tipe', ['Alat' => 'Alat', 'Other' => 'Other'] , null, ['class'=> 'form-control select2','id'=>'Tipe1','autocomplete'=>'off','required','style'=>'width: 100%','placeholder'=>''])); ?>

                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?php echo e(Form::label('No Alat', 'Kode Tagging:')); ?>

                            <?php echo e(Form::select('no_asset_alat', $Alat->sort(), null, ['class'=> 'form-control select2','id'=>'Alat1','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>''])); ?>
                    ...
                    <!--        <?php echo e(Form::select('kode_lokasi', $Lokasi->sort(), null, ['class'=> 'form-control select2','id'=>'Lokasi1','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>''])); ?>-->
                    <!--    </div>-->
                    <!--</div>-->
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textarea('keterangan', null, ['class'=> 'form-control','rows'=>'2','id'=>'Ket1', 'placeholder'=>'', 'autocomplete'=>'off','onkeypress'=>"return pulsar(event,this)"])); ?>
...
<div class="modal fade" id="editform" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo e(Form::hidden('no_wo', null, ['class'=> 'form-control','id'=>'NoWo2','autocomplete'=>'off'])); ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::text('no_reff', null, ['class'=> 'form-control','id'=>'NoReff2','autocomplete'=>'off'])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::datetimelocal('date_in', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'DateIn2' ,'required','onchange'=>"hitungdate2()"])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::datetimelocal('date_finish', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'DateFinish2' ,'required','onchange'=>"hitungdate2()"])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('tipe', ['Alat' => 'Alat', 'Other' => 'Other'] ,null, ['class'=> 'form-control select2','id'=>'Tipe2','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>''])); ?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::select('no_asset_alat', $Alat->sort(),null, ['class'=> 'form-control select2','id'=>'Alat2','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>''])); ?>

                        </div>
                    </div>
                    <!--<div class="col-md-4">-->
                    <!--    <div class="form-group">-->
                    <!--        <?php echo e(Form::label('No Alat', 'Lokasi:')); ?>-->
                    <!--        <?php echo e(Form::select('kode_lokasi', $Lokasi->sort(), null, ['class'=> 'form-control select2','id'=>'Lokasi2','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>''])); ?>-->
                    <!--    </div>-->
                    <!--</div>-->
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <?php echo e(Form::textarea('keterangan', null, ['class'=> 'form-control','rows'=>'2','id'=>'Ket2', 'placeholder'=>'', 'autocomplete'=>'off','onkeypress'=>"return pulsar(event,this)"])); ?>
        ...
        <div id="mySidenav" class="sidenav">
            <?php if (app('laratrust')->can('update-workorder')) : ?>
            ...
            <?php if (app('laratrust')->can('delete-workorder')) : ?>
            ...
            <?php if (app('laratrust')->can('add-workorder')) : ?>
            ...
            <?php if (app('laratrust')->can('print-workorder')) : ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        function hitungdate()
        {
            ...
            $.ajax({
                url: '<?php echo route('workorder.hitungdate'); ?>',
                    type: 'POST',
                    data : {
                        'tglin': tglin,
                        'tglfinish': tglfinish
        ...
        $(function() {
            $("#data-table").DataTable({
                ...
                "pageLength":100,
                "order": [[3, "desc"]],
                ajax: '<?php echo route('workorder.data'); ?>',
                data:[],
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('workorder.getkode'); ?>',
                        type:'POST',
        ...
        function limiter() {
            $.ajax({
                url: '<?php echo route('workorder.limitos'); ?>',
                type: 'GET',
                data : {
                },
                success: function(results) {
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    $.ajax({
                        url: '<?php echo route('workorder.historia'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_pembelian
                        },
            ...
            $('#button1').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('workorder.post'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembelian
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('workorder.unpost'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembelian
                            },
            ...
            $('#button7').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('workorder.approve'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembelian
                            },
            ...
            $('#button8').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('workorder.disapprove'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembelian
                            },
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('workorder.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_pembelian
                    },
            ...
            $('#editpembelian').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('workorder.edit_pembelian'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_pembelian
                    },
            ...
            $('#hapuspembelian').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('workorder.hapus_pembelian'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembelian
                            },
            ...
            $('#voidpembelian').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('workorder.void_pembelian'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_pembelian
                            },
        ...
        function get_ppn(){
            ...
            $.ajax({
                url:'<?php echo route('workorder.get_ppn'); ?>',
                type:'POST',
                data : {
        ...
        $('#ADD').submit(function (e) {
            ...
            var today = now.getFullYear()+"-"+(month)+"-"+(day) ;
                ...
                $.ajax({
                    url:'<?php echo route('workorder.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('workorder.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#editform').modal('hide');
