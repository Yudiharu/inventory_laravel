                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('no_pembelian',$Pembelian,null, ['class'=> 'form-control select2','style'=>'width: 100%','id'=>'Pembelian1','required'=>'required'])); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        function hitungjurnal(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'<?php echo route('penerimaan.hitungjurnal'); ?>',
                        type:'POST',
        ...
        function getkode(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                    $.ajax({
                        url:'<?php echo route('penerimaan.getkode'); ?>',
                        type:'POST',
                        success: function(result) {
                            swal("Berhasil!", result.message, "success");
                            refreshTable();
        ...
        function limiter() {
            $.ajax({
                        url: '<?php echo route('penerimaan.limitos'); ?>',
                        type: 'GET',
                        data : {
                        },
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    $.ajax({
                        url: '<?php echo route('penerimaan.historia'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_penerimaan
                        },
                    ...
                    $.ajax({
                        url: '<?php echo route('penerimaan.grandios'); ?>',
                        type: 'GET',
                        data : {
            ...
            $('#detailjurnal2').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('penerimaan.getDatajurnal2'); ?>',
                    type: 'GET',
                    data : {
                        'id': no_journal,
                    },
            ...
            function cekjurnal2(){
                ...
                $.ajax({
                    url:'<?php echo route('penerimaan.cekjurnal2'); ?>',
                    type:'POST',
                    data : {
