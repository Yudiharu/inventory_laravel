...
<?php $__env->startSection('title', 'Request Pembelian'); ?>
            ...
            <?php echo Form::open(['id'=>'ADD']); ?>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('Tanggal Request', 'Tanggal Request:')); ?>

                                    <?php echo e(Form::date('tgl_request', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'=>'required'])); ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::textarea('keterangan', null, ['class'=> 'form-control','rows'=>'2','id'=>'Keterangan1', 'placeholder'=>'Keterangan', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                ...
                <?php echo Form::open(['id'=>'EDIT']); ?>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?php echo e(Form::label('No Request', 'No Request:')); ?>

                                        <?php echo e(Form::text('no_request', null, ['class'=> 'form-control','id'=>'Request','readonly'])); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('tgl_request', null,['class'=> 'form-control','id'=>'Tanggal'])); ?>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            $("#data-table").DataTable({
                ...
                "scrollX": 400,
                "pageLength":100,
                ajax: '<?php echo route('requestpembelian.data'); ?>',
                data:[],
        ...
        function limiter() {
            $.ajax({
                url: '<?php echo route('requestpembelian.limitos'); ?>',
                type: 'GET',
                data : {
                },
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    $.ajax({
                        url: '<?php echo route('requestpembelian.previewpo'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_request
                        },
                    ...
                    $.ajax({
                        url: '<?php echo route('requestpembelian.historia'); ?>',
                        type: 'GET',
                        data : {
                            'id': no_request
                        },
            ...
            $('#button1').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('requestpembelian.post'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_memo
                            },
            ...
            $('#button2').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('requestpembelian.unpost'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_memo
                            },
            ...
            $('#button3').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
                        $.ajax({
                            url: '<?php echo route('requestpembelian.closing'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_request
                            },
            ...
            $('#button7').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('requestpembelian.approve'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_memo
                            },
            ...
            $('#button8').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                        $.ajax({
                            url: '<?php echo route('requestpembelian.disapprove'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_memo
                            },
            ...
            $(document).on('click', '#btn-save', function() {
                ...
                $.ajax({
                    url: '<?php echo route('requestpembelian.ttd_buat'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_memo,
                        'img': img,
            ...
            $(document).on('click', '#btn-periksa', function() {
                ...
                var no_memo = data['no_memo'];
                $.ajax({
                    url: '<?php echo route('requestpembelian.ttd_periksa'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_memo,
                        'img': img,
            ...
            $(document).on('click', '#btn-setuju', function() {
                ...
                var no_memo = data['no_memo'];
                $.ajax({
                    url: '<?php echo route('requestpembelian.ttd_setuju'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_memo,
                        'img': img,
            ...
            $(document).on('click', '#btn-tahu', function() {
                ...
                var no_memo = data['no_memo'];
                $.ajax({
                    url: '<?php echo route('requestpembelian.ttd_tahu'); ?>',
                    type: 'POST',
                    data : {
                        'no': no_memo,
                        'img': img,
            ...
            $('#button5').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('requestpembelian.showdetail'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_memo
                    },
            ...
            $('#editpembelian').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '<?php echo route('requestpembelian.edit_request'); ?>',
                    type: 'POST',
                    data : {
                        'id': no_request
                    },
            ...
            $('#hapuspembelian').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('requestpembelian.hapus_request'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_request
                            },
            ...
            $('#voidpembelian').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('requestpembelian.void_request'); ?>',
                            type: 'POST',
                            data : {
                                'id': no_memo
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var today = now.getFullYear()+"-"+(month)+"-"+(day) ;
                ...
                $.ajax({
                    url:'<?php echo route('requestpembelian.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('requestpembelian.updateajax'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#editform').modal('hide');
