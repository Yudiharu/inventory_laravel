	...
	<table class="table_content" style="margin-bottom: 25px;width: 100%;">
        ...
        ?>
            ...
            <tr class="border">
                ...
                <td class="border" align="left"><?php echo $row->no_returpembelian?></td>
                <td class="border" align="left"><?php echo $row->no_pembelian?></td>
                <td class="border" align="left"><?php echo $row->no_penerimaan?></td>
                <td class="border" align="left"><?php echo $row->tanggal_returpembelian?></td>
                ...
                <td class="border" align="right"><?php echo $row->landedcost ?></td>
            </tr>
