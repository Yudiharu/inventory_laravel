                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {{ Form::select('tipe', ['Alat' => 'Alat', 'Other' => 'Other'] , null, ['class'=> 'form-control select2','id'=>'Tipe1','autocomplete'=>'off','required','style'=>'width: 100%','placeholder'=>'']) }}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            {{ Form::select('tipe', ['Alat' => 'Alat', 'Other' => 'Other'] ,null, ['class'=> 'form-control select2','id'=>'Tipe2','autocomplete'=>'off','style'=>'width: 100%','placeholder'=>'']) }}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
