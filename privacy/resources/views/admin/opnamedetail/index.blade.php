...
@section('content')
    ...
    <span class="pull-right">
        ...
        <a href="https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/opnamedetail/exportpdf?no_opname={{$opname->no_opname}}" target="_blank" id="getform"><button type="button" class="btn btn-warning btn-xs print-button" id="button6">GET FORM OPNAME <i class="fa fa-print"></i></button></a>
