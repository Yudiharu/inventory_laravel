                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::date('tgl_memo', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal1' ,'required'=>'required'])}}
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::textarea('keterangan', null, ['class'=> 'form-control','rows'=>'2','id'=>'Keterangan1', 'placeholder'=>'Keterangan', 'autocomplete'=>'off','required', 'onkeypress'=>"return pulsar(event,this)"]) }}
                                 </div>
                            </div>                        
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('no_memo', null, ['class'=> 'form-control','id'=>'Pembelian','readonly']) }}
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('Tanggal Memo', 'Tanggal Memo:') }}
                                        {{ Form::date('tgl_memo', null,['class'=> 'form-control','id'=>'Tanggal'])}}
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
        ...
        $(document).ready(function() {
            ...
            $('#hapuspembelian').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '{!! route('memo.hapus_pembelian') !!}',
                            type: 'POST',
                            data : {
                                'id': no_memo
                            },
