                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('no_pembelian',$Pembelian,null, ['class'=> 'form-control select2','style'=>'width: 100%','placeholder' => '','id'=>'Pembelian','required'=>'required']) }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::date('tanggal_penerimaan', \Carbon\Carbon::now(),['class'=> 'form-control','id'=>'Tanggal','required'=>'required'])}}
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('no_penerimaan', null, ['class'=> 'form-control','id'=>'Penerimaan1','readonly']) }}
                                    </div>
                                </div> 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('No Pembelian', 'No Pembelian:') }}
                                        {{ Form::select('no_pembelian',$Pembelian,null, ['class'=> 'form-control select2','style'=>'width: 100%','id'=>'Pembelian1','required'=>'required']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        {{ Form::label('Tanggal Penerimaan', 'Tanggal Penerimaan:') }}
                                        {{ Form::date('tanggal_penerimaan', null,['class'=> 'form-control','id'=>'Tanggal1'])}}
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        function hitungjurnal(){
            swal({
                ...
                if (e.value === true) {
                    ...
                    $.ajax({
                        url:'{!! route('penerimaan.hitungjurnal') !!}',
                        type:'POST',
            ...
            columns: [
                ...
                { data: 'no_pembelian', 
                    render: function(data, type, row, meta){
                        if(type === 'display'){
                            data = '<a href="https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/pembelian/exportpdf?no_pembelian='+ data +'" target="_blank">' + data + '</a>';
                        }
                        return data;
                    }
                },
        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addpenerimaan").attr("href",window.location.href+"/"+no_penerimaan+"/detail");
                    var print = $("#printpenerimaan").attr("href",window.location.href+"/exportpdf?no_penerimaan="+no_penerimaan);
                    var print2 = $("#printzoom3").attr("href",window.location.href+"/exportpdf2?no_journal="+no_journal + "&no_penerimaan="+no_penerimaan);
                    ...
                    if(status == 'POSTED' && item > 0){
                        ...
                        $('.view-button').show();
                        $('.zoom-button').hide();
                    }else if(status =='OPEN' && item == 0 || item == null){
                        $('.tombol1').hide();
                        $('.tombol2').hide();
                        $('.add-button').show();
                        $('.hapus-button').show();
            ...
            $('#button1').click( function () {
                ...
                swal({
                    ...
                    reverseButtons: !0
                        ...
                        if (e.value === true) {
                            swal({
                            title: "<b>Proses Sedang Berlangsung !!! JANGAN REFRESH !!!</b>",
                            type: "warning",
                            showCancelButton: false,
                            showConfirmButton: false,
            ...
            $('#button2').click( function () {
                ...
                // alert( table.rows('.selected').data().length +' row(s) selected' );
                $.ajax({
                    url: '{!! route('penerimaan.unposting') !!}',
                    type: 'POST',
                    data : {
                        'id': no_penerimaan
                    },
            ...
            $('#detailjurnal2').click( function () {
                var select = $('.selected').closest('tr');
                var no_journal = select.find('td:eq(5)').text();
                $.ajax({
                    url: '{!! route('penerimaan.getDatajurnal2') !!}',
                    type: 'GET',
                    data : {
                        'id': no_journal,
                    },
            ...
            function cekjurnal2(){
                ...
                $.ajax({
                    url:'{!! route('penerimaan.cekjurnal2') !!}',
                    type:'POST',
                    data : {
            ...
            $('#button4').click( function () {
                ...
                $.ajax({
                    url: '{!! route('penerimaan.showdetail') !!}',
                    type: 'POST',
                    data : {
                        'id': no_penerimaan
                    },
            ...
            $('#editpenerimaan').click( function () {
                ...
                var row = table.row( select );
                $.ajax({
                    url: '{!! route('penerimaan.edit_penerimaan') !!}',
                    type: 'POST',
                    data : {
                        'id': no_penerimaan
                    },
                    success: function(results) {
                        ...
                        $('#Pembelian1').val(results.no_pembelian).trigger('change');
            ...
            $('#hapuspenerimaan').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '{!! route('penerimaan.hapus_penerimaan') !!}',
                            type: 'POST',
                            data : {
                                'id': no_penerimaan
                            },
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'{!! route('penerimaan.updateajax') !!}',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        $('#editform').modal('hide');
