                    ...
                    {!! Form::open(['id'=>'ADD_DETAIL']) !!}
                      <center><kbd>ADD FORM</kbd></center><br>
                        <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        {{ Form::label('No Penerimaan', 'Jenis:') }}
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('harga',null, ['class'=> 'form-control','required'=>'required','id'=>'HPP','autocomplete'=>'off','readonly']) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group2">
                                        ...
                                        {{ Form::text('kode_satuan', null, ['class'=> 'form-control','required'=>'required','id'=>'satuannon','autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                                    </div>
                                </div>
                            ...
                            <div class="row">   
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        {{-- {{ Form::text('kode_satuan', null, ['class'=> 'form-control']) }} --}}
                                        {{ Form::text('harga',null, ['class'=> 'form-control','id'=>'Harga','required'=>'required','readonly','autocomplete'=>'off']) }}
                                    </div>
                                </div>
        ...
        function edit(id, url) {
               ...
               $.ajax({
                    ...
                    success: function (results) {
                        ...
                        $("#Satuan2").html('');
                        $.each(results.kode_satuan, function(key, value){
                            $('#Satuan2').val('');
                            $("#Satuan2").append('<option value="'+ key +'">' + value + '</option>');
                            $('#Satuan2').val('');
                        });
