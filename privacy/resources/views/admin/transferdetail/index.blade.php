...
@section('content')
    ...
    <span class="pull-right">
        <font style="font-size: 16px;"> Detail transfer <b>{{$transfer->no_transfer}}</b></font>
    </span>
@include('sweet::alert')
<body onLoad="load()">
                        ...
                        <div class="row">   
                            <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('no_transfer', $transfer->no_transfer, ['class'=> 'form-control','readonly','id'=>'notransfer']) }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        {{ Form::label('hpp', 'HPP:') }}
                                        {{ Form::text('hpp',null, ['class'=> 'form-control','id'=>'Hpp','readonly']) }}
                                    </div>
                                </div>
                ...
                {!! Form::open(['id'=>'UPDATE_DETAIL']) !!}
                 <center><kbd>EDIT FORM</kbd></center><br>
                    <div class="row">   
                        <div class="col-md-2">
                                <div class="form-group">
                                    {{ Form::label('no_transfer', 'No transfer:') }}
                                    {{ Form::hidden('id', null, ['class'=> 'form-control','id'=>'ID']) }}
                                    
                                    {{ Form::text('no_transfer',$transfer->no_transfer, ['class'=> 'form-control','readonly','id'=>'transfer_e']) }}
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    {{ Form::label('hpp', 'HPP:') }}
                                    {{ Form::text('hpp',null, ['class'=> 'form-control','id'=>'Hpp_e','required'=>'required','readonly']) }}
                                </div>
                            </div>
...
@push('js')
  ...
  <script>
        ...
        function stock(){
            ...
            $.ajax({
                url:'{!! route('transferdetail.stockproduk') !!}',
                type:'POST',
                data : {
                        'id': kode_produk,
                    },
        ...
        function editpart(){
                    ...
                    $.ajax({
                    url: "{!! route('transferdetail.selectpart') !!}",
                    method: 'POST',
        ...
        function getharga(){
            ...
            var submit = document.getElementById("submit");
            $.ajax({
                url:'{!! route('transferdetail.getharga') !!}',
                type:'POST',
                data : {
                        'id': kode_produk,
                        'part': partnumber,
        ...
        function check(){
            ...
            var submit = document.getElementById("submit");
            $.ajax({
                url:'{!! route('transferdetail.qtycheck') !!}',
                type:'POST',
                data : {
                        'id': kode_produk,
                        'satuan': satuan,
        ...
        function cek_qty2(){
            ...
            var qty = $('#QTY_e').val();
             ...
             $.ajax({
                url:'{!! route('transferdetail.qtyproduk2') !!}',
                type:'POST',
                data : {
        ...
        function editsatuan(){
                    ...
                    var token = $("input[name='_token']").val();
                $.ajax({
                    url: "{!! route('transferdetail.selectAjax') !!}",
                    method: 'POST',
                    data: {kode_produk:kode_produk, _token:token},
                    success: function(data) {
                        $("#Satuan_e").html('');
        ...
        $('#UPDATE_DETAIL').submit(function (e) {
            ...
            // Check if empty of not
                $.ajax({
                    url:'{!! route('transferdetail.updateajax') !!}',
                    type:'POST',
                    data:formData,
                    success:function(data) {
