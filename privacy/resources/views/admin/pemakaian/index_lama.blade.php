        ...
        $(document).ready(function() {
            ...
            $('#data-table tbody').on( 'click', 'tr', function () {
                if ( $(this).hasClass('selected bg-gray text-bold') ) {
                    ...
                    var add = $("#addpemakaian").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/pemakaian/"+no_pemakaian+"/detail");
                    var print = $("#printpemakaian").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/pemakaian/export2?no_pemakaian="+no_pemakaian);
                    var print2 = $("#printzoom3").attr("href","https://aplikasi.gui-group.co.id/gui_inventory_laravel/admin/pemakaian/exportpdf3?no_journal="+no_journal + "&no_pemakaian="+no_pemakaian);
